...
namespace TDSMAN.Reports.Certificates {
    ...
    public class crITR24QForm : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "TDSMAN.Reports.Certificates.crITR24QForm.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedcrITR24QForm : Component, ICachedReport {
        
        public CachedcrITR24QForm() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            crITR24QForm rpt = new crITR24QForm();
            rpt.Site = this.Site;
            return rpt;
        }
