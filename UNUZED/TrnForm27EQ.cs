...
namespace TDSMAN.FormTrn
{
    ...
    public partial class TrnForm27EQ : TDSMAN.FormGen.GenForm
    {
        ...
        #region BACK
            ...
            private void BtnCancel_Click(object sender, System.EventArgs e)
            {
                ...
                {                   
                    ...
                    //================================================
                    if (TdsMan.LockBasicInfoEntry(T_FormNo.F27EQ) == false)
                    {
                        BtnExit.Select();
                        return;
                    }
        ...
        private void cmbMain_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //TDSMAN.Classes.TDSMAN.T_pBasicInfoId = lngBasicInfoID;
            ////================================================
            //if (TdsMan.LockBasicInfoEntry(T_MODULENAME.FORM_27EQ) == false)
            //{
        ...
        private void btnChallanDeducteeEntry_Click(object sender, EventArgs e)
        {
            ...
            else if (lblSearchMode.Text == Tabbed_Mode.Challan)
            {
                ...
                strSQL = " SELECT SECTION_ID," +
                    "             SECTION_NO " +
                    "      FROM   MST_SECTION " +
                    "      WHERE  FORM_NAME ='" + T_FormNo.F27EQ + "' " +
                    "      ORDER BY SECTION_ID";
                ...
                if (cmbDDSection.Visible == true)
                    ...
                    btnVerifyPAN.Location = new Point(69, 68);
                //--
                //--
        ...
        private void txtDeducteePAN_Enter(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    lstPANHelp.Items.Add(new ListBoxItem("Collectees exist with same PAN - "));
        ...
        private void txtTotalValueOfPurchase_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (mainVB.gTextBoxValidation(Convert.ToInt16(e.KeyChar), "N,12,2", txtTotalValueOfPurchase, "") == false)
                e.Handled = true;
        }
        #endregion
        ...
        private void btnPrint27A_Click(object sender, EventArgs e)
        {
            ...
            TDSMAN.Classes.TDSMAN.T_pForm27B = 1;
        ...
        #region TrnForm27EQ_FormClosing
        private void TrnForm27EQ_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private bool ValidateFields()
        {
            try
            {
                ...
                else if (lblSearchMode.Text == Tabbed_Mode.Deductee)
                {
                    ...
                    //-- TAX DEPOSITED
                    //-----------------------------------------------------------------------
                    //COMMENTED BY SHREY KEJRIWAL ON 24/02/2012
                    //if (Convert.ToDouble(cmnService.J_NumericData(txtDeducteeTaxDeposited)) == 0 && rbnNormal.Checked == true )
                    //{
                    //    cmnService.J_UserMessage("Tax Deposited - Cannot be Blank");
                    ...
                    case J_Mode.Add:
                        ...
                        if (lblSearchMode.Text == Tabbed_Mode.Challan)
                        {
                            ...
                            if (chkBookEntry.Checked == true)
                                intBookEntry = 1;
                            //
                            //MODIFIED BY DHRUB ON 10/01/2014 
                            if (chkBookEntry.Checked == false)
                            {
                                if (cmbMinorHead.SelectedIndex > 0)
        ...
        private bool GenerateTextFile(string strInputFilePath)
        {
            ...
            try
            {
                ...
                cmnService.J_WriteLine(ref StreamWriter, TdsMan.T_WriteField(intPageNumber.ToString()) + TdsMan.T_WriteField("FH") + TdsMan.T_WriteField("TC1") +
                ...
                if (lngArrayCounter > 0)
                {
                    ...
                    for (long lngCounter = 0; lngCounter <= lngArrayCounter - 1; lngCounter++)
                    {
                        ...
                        // DEDUCTEE DETAIL
                        //string[,] strGenerateTextFile = {{"MST_DEDUCTEE.DEDUCTEE_PAN = 'PANNOTAVBL'", "F", "", "T"},
                        ...
                        //             //cmnService.J_SQLDBFormat(strGenerateTextFile, J_SQLColFormat.Case_End) + " AS NON_DEDUCTION_FLAG," +
                        //             "   TRN_DEDUCTEE_DETAILS.TOT_VALUE_PURCHASE       AS TOT_VALUE_PURCHASE ";
                        //else
                            strSQL = strSQL + "TRN_DEDUCTEE_DETAILS.NON_DEDUCTION_FLAG AS NON_DEDUCTION_FLAG," +
                                     "   TRN_DEDUCTEE_DETAILS.TOT_VALUE_PURCHASE       AS TOT_VALUE_PURCHASE ";
                        ...
                        while (drdGenDeductee.Read())
                        {
                            ...
                            cmnService.J_WriteLine(ref StreamWriter, TdsMan.T_WriteField(intPageNumber.ToString()) + TdsMan.T_WriteField("DD") + TdsMan.T_WriteField("1") +
                                            ...
                                            TdsMan.T_WriteBlankField(1, "^") +
                                            TdsMan.T_WriteField(Convert.ToString(drdGenDeductee["TOT_VALUE_PURCHASE"]), "0.00") +
        ...
        private void LoadChallanFormComponents()
        {
            if (Support.GetItemData(cmbFinancialYear, cmbFinancialYear.SelectedIndex) <= T_FinancialYearID.F2012_13ID)
            {
                ...
                label13.Location = new Point(23, 76);
                mskDateOfPayment.Location = new Point(170, 74);
                label52.Location = new Point(254, 77);

                lblBSRCode.Location = new Point(14, 99);
                txtBSRCode.Location = new Point(170, 96);

                lblTrVchNo.Location = new Point(14, 121);
                txtTransferVoucherNo.Location = new Point(170, 118);
                txtChallanNo.Location = new Point(170, 118);

                lblCheque.Location = new Point(57, 143);
                txtChequeNo.Location = new Point(170, 140);

                label48.Location = new Point(99, 165);
                txtTDS.Location = new Point(170, 162);

                label49.Location = new Point(66, 187);
                txtSurcharge.Location = new Point(170, 184);

                label51.Location = new Point(36, 209);
                txtEducationCess.Location = new Point(170, 206);

                label50.Location = new Point(81, 230);
                txtInterests.Location = new Point(170, 227);

                label70.Location = new Point(68, 252);
                txtFee.Location = new Point(170, 248);

                label55.Location = new Point(87, 274);
                txtOthers.Location = new Point(170, 271);

                label54.Location = new Point(95, 297);
                txtTotalTax.Location = new Point(170, 294);

                lblMinor.Location = new Point(-8, 307);
                cmbMinorHead.Location = new Point(164, 303);

                lblRemarks.Location = new Point(8, 328);
                txtRemarks.Location = new Point(68, 324);

                //lblInterestAllocated.Location = new Point(49, 345);
                //txtInterestAllocated.Location = new Point(170, 342);

                //lblOthersAllocated.Location = new Point(55, 366);
                //txtOthersAllocated.Location = new Point(130, 362);

                lblInterestAllocated.Location = new Point(43, 351);
                txtInterestAllocated.Location = new Point(164, 347);

                lblOthersAllocated.Location = new Point(49, 372);
                txtOthersAllocated.Location = new Point(164, 369);
            ...
            else
            {
                ...
                mskDateOfPayment.Location = new Point(164, 28);
                label52.Location = new Point(254, 30);

                lblBSRCode.Location = new Point(10, 55);
                txtBSRCode.Location = new Point(164, 53);

                lblTrVchNo.Location = new Point(9, 81);
                txtTransferVoucherNo.Location = new Point(164, 78);
                txtChallanNo.Location = new Point(164, 78);


                label48.Location = new Point(95, 110);
                txtTDS.Location = new Point(164, 107);

                label49.Location = new Point(62, 134);
                txtSurcharge.Location = new Point(164, 131);

                label51.Location = new Point(31, 158);
                txtEducationCess.Location = new Point(164, 155);

                label50.Location = new Point(79, 183);
                txtInterests.Location = new Point(164, 180);

                label70.Location = new Point(68, 205);
        ...
        private string ReturnGeneratedForm27APath()
        {
            ...
            string str27APdfFileName = "27A_" + txtTAN.Text + "_" + T_FormNo.F27EQ + "_" + cmbQuarter.Text + "_" + cmbFinancialYear.Text.Replace("-", "") + ".pdf";
