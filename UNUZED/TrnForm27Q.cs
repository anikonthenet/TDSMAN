...
{
    public partial class TrnForm27Q : TDSMAN.FormGen.GenForm
    {
        ...
        #endregion
        //----
        string strFormNo = T_FormNo.F27Q;
        ...
        private void TrnForm26Q_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //-----------------------------------------------------------
                lblTitle.Text = "Form 27Q (Foreign)";
                //-----------------------------------------------------------
        ...
        #region BACK
            ...
            private void BtnCancel_Click(object sender, System.EventArgs e)
            {
                ...
                {                    
                    ...
                    //================================================
                    if (TdsMan.LockBasicInfoEntry(T_FormNo.F27Q) == false)
                    {
                        BtnExit.Select();
                        return;
                    }
                    ...
                    if (lblSearchMode.Text == Tabbed_Mode.Basic)
                    {
                        ...
                        if (TDSMAN.Classes.TDSMAN.T_pBookMarkOption == true)
                        {
                            ...
                            if (dmlService.J_IsRecordExist("MST_BOOKMARK_DETAIL", strQuery) == true)
                            {
                                //Update the Form BookMarkDetail
        ...
        private void cmbMain_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //TDSMAN.Classes.TDSMAN.T_pBasicInfoId = lngBasicInfoID;
            ////================================================
            //if (TdsMan.LockBasicInfoEntry(T_MODULENAME.FORM_27Q) == false)
            //{
        ...
        private void btnChallanEntry_Click(object sender, EventArgs e)
        {
            ...
            strSQL = " SELECT SECTION_ID," +
                ...
                "      AND    ASST_ID  >= " + T_FinancialYearID.F2013_14ID + " " +
                "      ORDER BY SECTION_ID";
        ...
        private void txtSlNoSearch_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            //Added by Indrajit on 05-03-2013
        ...
        private void btnChallanDeducteeEntry_Click(object sender, EventArgs e)
        {
            ...
            if (lblSearchMode.Text == Tabbed_Mode.Basic)
            {
                ...
                strSQL = " SELECT SECTION_ID," +
                    ...
                    "      FROM   MST_SECTION " +
                    "      WHERE  FORM_NAME = '" + strFormNo + "' " +
                    "      AND    ASST_ID <= " + Support.GetItemData(cmbFinancialYear, cmbFinancialYear.SelectedIndex) + " " +
                    "      ORDER BY SECTION_ID";
                if (dmlService.J_PopulateComboBox(strSQL, ref cmbSection) == false) return;
                //-----------
                mskDateOfPayment.Text = System.DateTime.Now.ToString();
            ...
            else if (lblSearchMode.Text == Tabbed_Mode.Challan)
            {
                ...
                if (cmbDDSection.Visible == true)
                    btnVerifyPAN.Location = new Point(9, 68);
                else if (cmbDDSection.Visible == false)
                    btnVerifyPAN.Location = new Point(71, 68);
                //--
        ...
        private void txtDeducteePAN_TextChanged(object sender, EventArgs e)
        {
            try
            {//--------------------------------------------------------------------
                //ADDED BY DHRUB ON 21/01/2014 FOR TDS RATE COMPANY & NONCOMPANY WISE 
                //--------------------------------------------------------------------
                ShowRate();
                //--------------------------------------------------------------------                
        ...
        private void txtDeducteeTotal_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                //MODIFIED BY DHRUB ON 13/01/2014 FOR DEDUCTED DATE BACK COLOUR 
                //--------------------------------------------------------------
                if (lblMode.Text == J_Mode.Add)
                {
        ...
        #region TrnForm27Q_FormClosing
        private void TrnForm27Q_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private bool ShowChallanDetailsRecord(long Id)
        {
            ...
            try
            {
                ...
                //-------------------------------------------------
                //MODIFIED BY DHRUB ON 08/01/2014 
                //-------------------------------------------------
                strSQL = "SELECT TRN_CHALLAN.CHALLAN_ID          AS CHALLAN_ID," +
                    "            TRN_CHALLAN.SL_NO               AS SL_NO," +
                    "            TRN_CHALLAN.SECTION_ID          AS SECTION_ID," +
                ...
                while (drdShowChallanDetailsRecord.Read())
                {
                    ...
                    //if (txtViewChallanDetailsSection.Text == "195")
                    //{
                    //    if(Support.GetItemData(cmbFinancialYear, cmbFinancialYear.SelectedIndex) >= T_FinancialYearID.F2012_13ID)
                    //        //rbnSoftware.Visible = true;
                    //}
        ...
        private bool ShowDeducteeRecord(long Id)
        {
            ...
            try
            {
                ...
                strSQL = "SELECT TRN_DEDUCTEE_DETAILS.DEDUCTEE_DETAIL_ID   AS DEDUCTEE_DETAIL_ID," +
                    ...
                    "     FROM ((((((TRN_DEDUCTEE_DETAILS INNER JOIN MST_DEDUCTEE " +
            ...
            try
            {
                ...
                else if (lblSearchMode.Text == Tabbed_Mode.Challan)
                {
                    ...
                    if (Convert.ToInt32(Support.GetItemData(cmbFinancialYear, cmbFinancialYear.SelectedIndex)) < T_FinancialYearID.F2013_14ID)
                    {
                        ...
                        //-- ANIK @ 2013/09/26 for FVU 4.0
                        if (cmbSection.Text == "194LC")
                        {
                            if (txtDeductorType.Text.Substring(0, 1).ToUpper() != "M" && txtDeductorType.Text.Substring(0, 1).ToUpper() != "K")
                            {
                ...
                else if (lblSearchMode.Text == Tabbed_Mode.Deductee)
                {
                    ...
                    if (Convert.ToInt32(Support.GetItemData(cmbFinancialYear, cmbFinancialYear.SelectedIndex)) >= T_FinancialYearID.F2013_14ID)
                    {
                        ...
                        //-- ANIK @ 2013/09/26 for FVU 4.0
                        else if (cmbDDSection.Text == "194LC")
                        {
                            if (txtDeductorType.Text.Substring(0, 1).ToUpper() != "M" && txtDeductorType.Text.Substring(0, 1).ToUpper() != "K")
                            {
                                cmnService.J_UserMessage("Section 194LC is applicable only for deductor category 'Company' and 'Branch / Division of Company'.");
                    ...
                    //if (rbnHigherRate.Checked == true)15
                    ...
                    if (cmbRemarks.SelectedIndex > 0)
                    {
                        if (Convert.ToDouble(txtDeducteeTotal.Text) == 0 && Convert.ToInt32(Support.GetItemData(cmbRemarks, cmbRemarks.SelectedIndex)) == 17)
                        {
                ...
                switch (lblMode.Text)
                {
                    ...
                    case J_Mode.Add:
                        ...
                        if (lblSearchMode.Text == Tabbed_Mode.Challan)
                        {
                            ...
                            strSQL = "INSERT INTO TRN_CHALLAN (" +
                                     ...
                                     "            " + Convert.ToInt32(Support.GetItemData(cmbSection, cmbSection.SelectedIndex)) + "," +
                        ...
                        else if (lblSearchMode.Text == Tabbed_Mode.Deductee)
                        {
                            ...
                            strSQL = "INSERT INTO TRN_DEDUCTEE_DETAILS " +
                                     ...
                                     "            " + Convert.ToInt32(Support.GetItemData(cmbRemittance, cmbRemittance.SelectedIndex)) + "," +
                                     "            " + Convert.ToInt32(Support.GetItemData(cmbTDSRate, cmbTDSRate.SelectedIndex)) + "," +
                                     "            " + Convert.ToInt32(Support.GetItemData(cmbCountry, cmbCountry.SelectedIndex)) + "," +
                    ...
                    case J_Mode.Edit:
                        ...
                        else if (lblSearchMode.Text == Tabbed_Mode.Deductee)
                        {
                            ...
                            strSQL = "UPDATE TRN_DEDUCTEE_DETAILS SET " +
                                ...
                                "            REMITTANCE_ID        = " + Convert.ToInt32(Support.GetItemData(cmbRemittance, cmbRemittance.SelectedIndex)) + "," +
                                "            TDS_APPLICABILITY_ID = " + Convert.ToInt32(Support.GetItemData(cmbTDSRate, cmbTDSRate.SelectedIndex)) + "," +
                                "            COUNTRY_ID           = " + Convert.ToInt32(Support.GetItemData(cmbCountry, cmbCountry.SelectedIndex)) + "," +
                                "            UNIQUE_ACKN          ='" + cmnService.J_ReplaceQuote(txtUniqueAckn.Text) + "' " +
                    ...
                    case J_Mode.Delete:
                        ...
                        else if (lblSearchMode.Text == Tabbed_Mode.Deductee)
                        {
                            ...
                            // UPDATE TDS
                            dblSumValues = cmnService.J_ReturnDoubleValue(Convert.ToString(dmlService.J_ExecSqlReturnScalar("SELECT TAX_AMOUNT FROM TRN_DEDUCTEE_DETAILS WHERE DEDUCTEE_DETAIL_ID =  " + lngDeducteeID)));
                            strSQL = "UPDATE TRN_CHALLAN SET " +
                            ...
                            // RECALCALUTING SRL NO.
                            if (TdsMan.T_UpdateSrlNo(dmlService.J_pCommand, cmnService.J_ReturnInt32Value(Convert.ToString(dmlService.J_ExecSqlReturnScalar("SELECT SL_NO FROM TRN_DEDUCTEE_DETAILS WHERE DEDUCTEE_DETAIL_ID = " + lngDeducteeID))),
        ...
        private void LoadChallanGrid(long BasicInfoID)
        {
            ...
            //-------------------------------------------------------------
            //--BLOCKED BY DHRUB ON 08/01/2014 FOR DEDUCT FEE FOR CHALLAN 
            //-------------------------------------------------------------
            //-------------------------------------------------------------
        ...
        private void LoadDeducteeGrid(long ChallanDetailID, object sender, EventArgs e)
        {
            ...
            strQuery = "SELECT TRN_DEDUCTEE_DETAILS.DEDUCTEE_DETAIL_ID   AS DEDUCTEE_DETAIL_ID," +
                     ...
                     "  AND    TRN_DEDUCTEE_DETAILS.SECTION_ID = MST_SECTION.SECTION_ID " +
                     "  AND    TRN_DEDUCTEE_DETAILS.CHALLAN_ID = " + ChallanDetailID + " ";
            //strSQLGridViewTabPages = "SELECT TRN_DEDUCTEE_DETAILS.DEDUCTEE_DETAIL_ID   AS DEDUCTEE_DETAIL_ID," +
            //                         "       TRN_DEDUCTEE_DETAILS.SL_NO                AS SL_NO," +
            //                         "       MST_DEDUCTEE.DEDUCTEE_ID                  AS DEDUCTEE_ID," +
            //                         "       MST_DEDUCTEE.DEDUCTEE_PAN                 AS DEDUCTEE_PAN," +
            //                         "       MST_DEDUCTEE.DEDUCTEE_NAME                AS DEDUCTEE_NAME," +
            ...
            //                         "WHERE  TRN_DEDUCTEE_DETAILS.PARTY_ID   = MST_DEDUCTEE.DEDUCTEE_ID " +
            //                         "AND    TRN_DEDUCTEE_DETAILS.CHALLAN_ID = " + ChallanDetailID + " " +
            //                         "ORDER BY TRN_DEDUCTEE_DETAILS.DEDUCTEE_DETAIL_ID";
            //-----------------------------------------------------------
            strSQL = strQuery + "ORDER BY " + strOrderBy;
            //-----------------------------------------------------------
            if (dsetGridClone != null) dsetGridClone.Clear();
            ...
            try
            {
                ...
                cmnService.J_WriteLine(ref StreamWriter, TdsMan.T_WriteField(intPageNumber.ToString()) + TdsMan.T_WriteField("BH") + TdsMan.T_WriteField("1") +
                                    ...
                                    //TdsMan.T_WriteBlankField(2, "^") +
                                       ...
                                       TdsMan.T_WriteField(txtPAORegNo.Text) +
                ...
                if (lngArrayCounter > 0)
                {
                    ...
                    for (long lngCounter = 0; lngCounter <= lngArrayCounter - 1; lngCounter++)
                    {
                        ...
                        strSQL = "SELECT TRN_DEDUCTEE_DETAILS.DEDUCTEE_DETAIL_ID   AS DEDUCTEE_DETAIL_ID," +
                            ...
                            "            TRN_DEDUCTEE_DETAILS.CERTIFICATE_NO       AS CERTIFICATE_NO," +
                            "            MST_SECTION.SECTION_NAME                  AS SECTION_NAME," +
                            "            REMITTANCE_CODE                           AS REMITTANCE_CODE," +
                            "            TDS_APPLICABILITY_CODE                    AS TDS_APPLICABILITY_CODE," +
                        ...
                        strSQL = strSQL + "FROM ((((((TRN_DEDUCTEE_DETAILS INNER JOIN MST_DEDUCTEE " +
                            "            ON  TRN_DEDUCTEE_DETAILS.PARTY_ID = MST_DEDUCTEE.DEDUCTEE_ID) " +
                            "            INNER JOIN MST_REASON " +
                            "            ON TRN_DEDUCTEE_DETAILS.REASON_ID = MST_REASON.REASON_ID) " +
                            "            INNER JOIN MST_SECTION " +
        ...
        private void LoadNILReturn(object sender, EventArgs e)
        {
                ...
                //-----------------------------------------------------------
            bool blChecked = chkNILReturn.Checked;
                ...
                if (TdsMan.LockBasicInfoEntry(T_FormNo.F27Q) == false)
                {
                    chkNILReturn.Checked = blChecked;
        ...
        private void LoadChallanFormComponents()
        {
            if (Support.GetItemData(cmbFinancialYear, cmbFinancialYear.SelectedIndex) <= T_FinancialYearID.F2012_13ID)
            {
                ...
                //lblSection.Location = new Point(76, 32);
                ...
                lblDOP.Location = new Point(lblDOP.Location.X, 72);
                mskDateOfPayment.Location = new Point(mskDateOfPayment.Location.X, 72);
                lblDOPFormat.Location = new Point(lblDOPFormat.Location.X, 72);

                //lblBSRCode.Location = new Point(8, 35);
                //txtBSRCode.Location = new Point(164, 32);


                lblBSRCode.Location = new Point(lblBSRCode.Location.X, 93);
                txtBSRCode.Location = new Point(txtBSRCode.Location.X, 93);

                //lblTrVchNo.Location = new Point(8, 57);
                //txtTransferVoucherNo.Location = new Point(164, 54);
                //txtChallanNo.Location = new Point(164, 54);

                lblTrVchNo.Location = new Point(lblTrVchNo.Location.X, 115);
                txtTransferVoucherNo.Location = new Point(txtTransferVoucherNo.Location.X,115);
                txtChallanNo.Location = new Point(txtChallanNo.Location.X,115);

                //lblCheque.Location = new Point(51, 79);
                //txtChequeNo.Location = new Point(164, 76);

                lblCheque.Location = new Point(lblCheque.Location.X, 139);
                txtChequeNo.Location = new Point(txtChequeNo.Location.X, 136);

                //lblTDS.Location = new Point(93, 101);
                //txtTDS.Location = new Point(164, 98);

                lblTDS.Location = new Point(lblTDS.Location.X, 158);
                txtTDS.Location = new Point(txtTDS.Location.X, 158);

                //lblSurc.Location = new Point(93, 123);
                //txtSurcharge.Location = new Point(164, 120);

                lblSurc.Location = new Point(lblSurc.Location.X, 180);
                txtSurcharge.Location = new Point(txtSurcharge.Location.X, 180);

                //lblEduCess.Location = new Point(63, 145);
                //txtEducationCess.Location = new Point(164, 142);

                lblEduCess.Location = new Point(lblEduCess.Location.X, 202);
                txtEducationCess.Location = new Point(txtEducationCess.Location.X, 202);

                //lblInt.Location = new Point(75, 167);
                //txtInterests.Location = new Point(164, 164);

                lblInt.Location = new Point(lblInt.Location.X, 224);
                txtInterests.Location = new Point(txtInterests.Location.X, 224);

                //label66.Location = new Point(75, 189);
                //txtFee.Location = new Point(164, 186);

                lblFee.Location = new Point(lblFee.Location.X, 246);
                txtFee.Location = new Point(txtFee.Location.X, 246);

                //lblOthers.Location = new Point(81, 212);
                //txtOthers.Location = new Point(164, 209);

                lblOthers.Location = new Point(lblOthers.Location.X, 268);
                txtOthers.Location = new Point(txtOthers.Location.X, 268);

                //lblTotal.Location = new Point(29, 234);
                //txtTotalTax.Location = new Point(164, 231);

                lblTotal.Location = new Point(lblTotal.Location.X, 290);
                txtTotalTax.Location = new Point(txtTotalTax.Location.X, 290);

                //lblRemarks.Location = new Point(8, 258);
                //txtRemarks.Location = new Point(68, 255);

                lblRemarks.Location = new Point(lblRemarks.Location.X, 312);
                txtRemarks.Location = new Point(txtRemarks.Location.X, 312);

                //lblInterestAllocated.Location = new Point(43, 285);
                //txtInterestAllocated.Location = new Point(164, 281);

                lblInterestAllocated.Location = new Point(lblInterestAllocated.Location.X, 334);
                txtInterestAllocated.Location = new Point(txtInterestAllocated.Location.X, 334);

                //lblOthersAllocated.Location = new Point(49, 306);
                //txtOthersAllocated.Location = new Point(164, 303);
                lblOthersAllocated.Location = new Point(lblOthersAllocated.Location.X, 356);
                txtOthersAllocated.Location = new Point(txtOthersAllocated.Location.X, 356);
            ...
            else // T_FinancialYearID.F2013_14ID
            {
                if (chkBookEntry.Checked == false)
                {
                    lblMinor.Visible = true;
                ...
                lblDOP.Location = new Point(lblDOP.Location.X, 27);
                ...
                lblBSRCode.Location = new Point(lblBSRCode.Location.X, 50);
                ...
                lblTrVchNo.Location = new Point(lblTrVchNo.Location.X, 72);
                ...
                lblEduCess.Location = new Point(lblEduCess.Location.X, 138);
                ...
                lblInt.Location = new Point(lblInt.Location.X, 160);
                ...
                lblTotal.Location = new Point(lblTotal.Location.X, 226);
                ...
                lblMinor.Location = new Point(lblMinor.Location.X, 248);
                ...
                lblRemarks.Location = new Point(lblRemarks.Location.X, 270);
                ...
                lblInterestAllocated.Location = new Point(lblInterestAllocated.Location.X, 292);
                ...
                lblOthersAllocated.Location = new Point(lblOthersAllocated.Location.X, 314);
        ...
        private string ReturnGeneratedForm27APath()
        {
            ...
            string str27APdfFileName = "27A_" + txtTAN.Text + "_" + T_FormNo.F27Q + "_" + cmbQuarter.Text + "_" + cmbFinancialYear.Text.Replace("-", "") + ".pdf";
        ...
        private void grpSearchDeductee_Enter(object sender, EventArgs e)
        {
