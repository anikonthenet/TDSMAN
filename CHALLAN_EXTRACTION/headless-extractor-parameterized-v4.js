    ...
    try {
        ...
        try {
            page = await executeWithTimeout(async () => {
                ...
                await newPage.waitForTimeout(3000);
                // === ACT SELECTION STEP ===
                // After clicking ePay Tax, a screen appears to select the applicable Income Tax Act.
                // We always select Income Tax Act, 1961 (for AY 2026-27 or earlier) and click Continue.
                await newPage.evaluate(() => {
                    const radio1961 = document.querySelector('#mat-radio-3-input');
                    if (radio1961) {
                        radio1961.click();
                    }
                });
...
                                        rowText.includes(targetBankRef)) {
                            ...
                            if (backClicked) {
                                ...
                                // After pressing Back from challan detail, the portal returns to the
                                // Act Selection screen. Select Income Tax Act, 1961 and click Continue.
                                await page.evaluate(() => {
                                    const radio1961 = document.querySelector('#mat-radio-3-input');
                                    if (radio1961) {
                                        radio1961.click();
