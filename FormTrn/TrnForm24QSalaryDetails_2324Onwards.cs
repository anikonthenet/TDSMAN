...
{
    public partial class TrnForm24QSalaryDetails_2324Onwards : TDSMAN.FormGen.GenForm
    {
        ResizeForm _form_resize;

        #region System Generated Code
        public TrnForm24QSalaryDetails_2324Onwards()
        {
            InitializeComponent();
            ////--
        ...
        double dblStandardDeduction2425NewRegime = 75000, dblStandardDeduction2425OldRegime = 50000;
        //
        double dblMAXTotalDeductibleAmount80C80CCC80CCCD1819 = 150000;
        double dblMAXTotalDeductibleAmount80TTA = 10000;
        //
        ...
        private void TrnForm24QSalaryDetails_Load(object sender, EventArgs e)
        {
            ...
            //-----------------------------------------------------------
            if (TDSMAN.Classes.TDSMAN.T_pFinancialYearId >= T_FinancialYearID.F2026_27ID)
                lblTitle.Text = "Form " + T_FormNo.F138_24Q + " Salary Details - Annexure II";
            else
            ...
            // 2024/12/27
            if (TDSMAN.Classes.TDSMAN.T_pFinancialYearId >= T_FinancialYearID.F2024_25ID)
            {
                lblUs192_2B.Enabled = true;
                txtUs192_2B.Enabled = true;
            }
            else
            {
                lblUs192_2B.Enabled = false;
                txtUs192_2B.Enabled = false;
            }
            //-- 2025/07/01
            if (chkOptOut115BAC_1A.Checked == true)
                lnkCheckInOtherRegime.Text = "Check in 'New' Regime";
            else if (chkOptOut115BAC_1A.Checked == false)
                lnkCheckInOtherRegime.Text = "Check in 'Old' Regime";
        }
        #endregion
        ...
        private void BtnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strCheckFields = "";
                //---------------------------------------------
                chkPopulateCalculation.Checked = true;
        ...
        #region TxtTotalTDSDedcuted_TextChanged
        private void TxtTotalTDSDedcuted_TextChanged(object sender, EventArgs e)
        {
            ...
            //
            Shortfall_TextChanged(sender, e);
        }
        #endregion
            ...
            try
            {
                ...
                if (TDSMAN.Classes.TDSMAN.T_ShareReferenceNoF24Q == true)
                {
                    strSQLShowHelpEmployee = "SELECT EMPLOYEE_ID," +
                       ...
                       "                     AND    MST_EMPLOYEE.EMPLOYEE_NAME LIKE '" + TDSMAN.Classes.TDSMAN.T_DeducteeSearchLikeOperator + cmnService.J_ReplaceQuote(txtEmployeeName.Text) + "%' " +
        ...
        private void txtTotalSalaryBalance_TextChanged(object sender, EventArgs e)
        {
            ...
            //-- 20240318
            txtDedTaxSection16ia_Enter(sender, e);
        }
        #endregion
            ...
            if (TDSMAN.Classes.TDSMAN.T_pFinancialYearId >= T_FinancialYearID.F2018_19ID)
            {
                ...
                if (TDSMAN.Classes.TDSMAN.T_pFinancialYearId >= T_FinancialYearID.F2024_25ID)
                    lblGrossTaxPayable.Text = string.Format("{0:0.00}", (cmnService.J_ReturnDoubleValue(lblTaxDeductingRebate.Text) +
                                                                     cmnService.J_ReturnDoubleValue(txtSurcharge.Text) +
                                                                     cmnService.J_ReturnDoubleValue(txtEducationCess.Text)));// +
                                                                     //cmnService.J_ReturnDoubleValue(txtUs192_2B.Text)));
            }
            else
            {
                //////lblTaxDeductingRebate.Text = string.Format("{0:0.00}", (cmnService.J_ReturnDoubleValue(txtTaxTotalIncome.Text) -
        ...
        private void Shortfall_TextChanged(object sender, EventArgs e)
        {
            ...
            if (TDSMAN.Classes.TDSMAN.T_pFinancialYearId >= T_FinancialYearID.F2013_14ID)
            {
                ...
                if (TDSMAN.Classes.TDSMAN.T_pFinancialYearId >= T_FinancialYearID.F2024_25ID)
                {
                    lblTotalBreakupTdsTcs.Text = string.Format("{0:0.00}", cmnService.J_ReturnDoubleValue(txtTotalTaxDeductedAmt.Text) + cmnService.J_ReturnDoubleValue(txtPreviousTaxDeductedAmt.Text) + cmnService.J_ReturnDoubleValue(txtUs192_2B.Text));
                    //lblShortfall.Text = string.Format("{0:0.00}", (cmnService.J_ReturnDoubleValue(lblTaxPayable.Text) - cmnService.J_ReturnDoubleValue(txtTotalTaxDeductedAmt.Text) - cmnService.J_ReturnDoubleValue(txtPreviousTaxDeductedAmt.Text) - cmnService.J_ReturnDoubleValue(txtUs192_2B.Text)));
                    lblShortfall.Text = string.Format("{0:0.00}", (cmnService.J_ReturnDoubleValue(lblTaxPayable.Text) - cmnService.J_ReturnDoubleValue(lblTotalBreakupTdsTcs.Text)));// - cmnService.J_ReturnDoubleValue(txtPreviousTaxDeductedAmt.Text) - cmnService.J_ReturnDoubleValue(txtUs192_2B.Text)));
                }
                else
                ...
                //if (TDSMAN.Classes.TDSMAN.T_pFinancialYearId >= T_FinancialYearID.F2024_25ID)
                //{
                //    //lblShortfall.Text = string.Format("{0:0.00}", (cmnService.J_ReturnDoubleValue(lblTaxPayable.Text) - cmnService.J_ReturnDoubleValue(lblTotalAmountOfTAX.Text) - cmnService.J_ReturnDoubleValue(txtUs192_2B.Text)));
                //    lblShortfall.Text = string.Format("{0:0.00}", (cmnService.J_ReturnDoubleValue(lblTaxPayable.Text) - cmnService.J_ReturnDoubleValue(txtTotalTaxDeductedAmt.Text) - cmnService.J_ReturnDoubleValue(txtPreviousTaxDeductedAmt.Text) - cmnService.J_ReturnDoubleValue(txtUs192_2B.Text)));
                //}
            //}
            //Added by Shrey Kejriwal on 03-04-2015
        ...
        private void lblTotalIncome_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                double dblTaxonTotalIncomeB4TaxCredit = 0, dblTaxonTotalIncomeB4TaxCreditMarginalRelief = 0;
                //
                //try
                //{
                ...
                //}
                //
                #region COMMENTED ON 2026/01/30
                /*
                ...
                if (Convert.ToInt32(TDSMAN.Classes.TDSMAN.T_pFinancialYearId) >= T_FinancialYearID.F2018_19ID)
                {
                    ...
                    lblTaxOnTotalIncomeCalculated.Text = string.Format("{0:0.00}", Convert.ToDouble(Convert.ToString(dblTaxonTotalIncomeB4TaxCredit)));
                    //-- 2024/04/25
                    if (Convert.ToInt32(TDSMAN.Classes.TDSMAN.T_pFinancialYearId) >= T_FinancialYearID.F2023_24ID)
                    {
                        if(dblTaxonTotalIncomeB4TaxCreditMarginalRelief > 0)
                        {
                            lblTaxOnTotalIncomeCalculated.Text = string.Format("{0:0.00}", Convert.ToDouble(Convert.ToString(dblTaxonTotalIncomeB4TaxCreditMarginalRelief)));
                ...
                if (dblCalculatedTax == 0)
                {
                    if (Convert.ToDouble(lblRebateCalculated.Text) < Convert.ToDouble(lblTaxOnTotalIncomeCalculated.Text))
                    {
                        lblTaxDeductingRebateCalculated.Text = string.Format("{0:0.00}", Convert.ToDouble(lblTaxOnTotalIncomeCalculated.Text) - Convert.ToDouble(lblRebateCalculated.Text));
                    }
                }
                */
                #endregion
                ...
                //--------------------------------------------------
                dblCalculatedTax = TdsMan.CalculateIncomeTaxAmount(
                                        intAsstId,
                                        strCategory,
                                        Convert.ToDouble(lblTotalIncome.Text),
                                        chkTaxation115BAC.Checked.ToString(),
                ...
                #region COMMENT
                ////--------------------------------------------------
                //// ROUNDING (AS PER YOUR EXISTING PRACTICE)
                ////--------------------------------------------------
                //dblCalculatedTax = Math.Round(dblCalculatedTax, 0);

                ////--------------------------------------------------
                //// DISPLAY : TAX BEFORE REBATE
                ////--------------------------------------------------
                //lblTaxOnTotalIncomeCalculated.Text =
                //    string.Format("{0:0.00}", dblTaxonTotalIncomeB4TaxCredit);

                ////--------------------------------------------------
                //// DISPLAY : REBATE (DIRECT FROM ENGINE)
                ////--------------------------------------------------
                ////lblRebateCalculated.Text =
                ////    string.Format("{0:0.00}", dblCalculatedTaxCredit);
                //if (TDSMAN.Classes.TDSMAN.T_pFinancialYearId >= T_FinancialYearID.F2023_24ID)
                //    lblTaxDeductingRebateCalculated.Text =
                //    string.Format("{0:0.00}", Convert.ToDouble(lblTaxOnTotalIncomeCalculated.Text) - Convert.ToDouble(lblRebateCalculated.Text));// dblCalculatedTax);
                //else
                //    lblRebateCalculated.Text =
                //        string.Format("{0:0.00}", dblCalculatedTaxCredit);

                //    //--------------------------------------------------
                //    // DISPLAY : FINAL TAX (AFTER REBATE)
                //    //--------------------------------------------------
                //    lblTaxDeductingRebateCalculated.Text =
                //    string.Format("{0:0.00}", dblCalculatedTax);

                ////--------------------------------------------------
                //// DISPLAY : SURCHARGE & CESS
                ////--------------------------------------------------
                //lblCalculatedSurcharge.Text =
                //    string.Format("{0:0.00}", dblCalculatedSurcharge);

                //lblTaxCalculatedECess.Text =
                //    string.Format("{0:0.00}", dblCalculatedECess);

                ////--------------------------------------------------
                //// SPECIAL CASE : AY 2024-25 MARGINAL RELIEF (ONLY)
                ////--------------------------------------------------
                //if (Convert.ToInt32(TDSMAN.Classes.TDSMAN.T_pFinancialYearId)
                //        == T_FinancialYearID.F2023_24ID)
                //{
                //    if (dblTaxonTotalIncomeB4TaxCreditMarginalRelief > 0)
                //    {
                //        // Show tax before marginal relief
                //        lblTaxOnTotalIncomeCalculated.Text =
                //            string.Format("{0:0.00}",
                //                dblTaxonTotalIncomeB4TaxCreditMarginalRelief);

                //        // Rebate = difference due to marginal relief
                //        lblRebateCalculated.Text =
                //            string.Format("{0:0.00}",
                //                dblTaxonTotalIncomeB4TaxCreditMarginalRelief
                //                - dblTaxonTotalIncomeB4TaxCredit);
                //    }
                //}
                #endregion
                //--------------------------------------------------
                // ROUND FINAL TAX (your existing practice)
                //--------------------------------------------------
                dblCalculatedTax = Math.Round(dblCalculatedTax, 0, MidpointRounding.AwayFromZero);
                //--------------------------------------------------
                // DISPLAY : TAX BEFORE REBATE
                //--------------------------------------------------
                lblTaxOnTotalIncomeCalculated.Text = string.Format("{0:0.00}", dblTaxonTotalIncomeB4TaxCredit);
                //--------------------------------------------------
                // DISPLAY : REBATE UNDER SECTION 87A
                //--------------------------------------------------
                dblCalculatedTaxCredit = Math.Min(dblCalculatedTaxCredit,  dblTaxonTotalIncomeB4TaxCredit);
                lblRebateCalculated.Text = string.Format("{0:0.00}", dblCalculatedTaxCredit);
                //--------------------------------------------------
                // DISPLAY : FINAL TAX (AFTER REBATE)
                //--------------------------------------------------
                //lblTaxDeductingRebateCalculated.Text = string.Format("{0:0.00}", dblCalculatedTax);
                lblTaxDeductingRebateCalculated.Text = string.Format("{0:0.00}", dblTaxonTotalIncomeB4TaxCredit - dblCalculatedTaxCredit);
                //--------------------------------------------------
                // DISPLAY : SURCHARGE
                //--------------------------------------------------
                lblCalculatedSurcharge.Text = string.Format("{0:0.00}", dblCalculatedSurcharge);
                //--------------------------------------------------
                // DISPLAY : HEALTH & EDUCATION CESS
                //--------------------------------------------------
                lblTaxCalculatedECess.Text = string.Format("{0:0.00}", dblCalculatedECess);
            }
            catch
            {
            }
        ...
        private void txtSec80C1819DeductibleAmount_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                ErrProvider.SetError(txtTotalDeductionSec80C80CCC80CCD11819DeductibleAmount, "Please check...\nMaximum amount limited to " + string.Format("{0:0.00}", dblMAXTotalDeductibleAmount80C80CCC80CCCD1819));
                //
        ...
        private void chkTaxation115BAC_CheckedChanged(object sender, EventArgs e)
        {
            if (chkTaxation115BAC.Checked == true)
            {
                ...
                if (TDSMAN.Classes.TDSMAN.T_pFinancialYearId >= T_FinancialYearID.F2023_24ID)
                {
                    lblTotalDeductions.Text = string.Format("{0:0.00}", (cmnService.J_ReturnDoubleValue(txtDedTaxSection16ia.Text)));
                }
                //-- END
                if (TDSMAN.Classes.TDSMAN.T_pFinancialYearId >= T_FinancialYearID.F2023_24ID) //-- 2023/11/21
                {
                    lblIncomeChargeable.Text = string.Format("{0:0.00}", ((cmnService.J_ReturnDoubleValue(txtTaxableAmount.Text) +
                                                                           cmnService.J_ReturnDoubleValue(txtReportedTaxableAmount.Text)) -
        ...
        {
            if (TDSMAN.Classes.TDSMAN.T_pFinancialYearId >= T_FinancialYearID.F2024_25ID) //-- 2024/11/28
            {
                if (chkTaxation115BAC.Checked == true)
                    strSQL = "SELECT SD_US_16_IA_LIMIT_NEW_REGIME FROM MST_ASSESSMENT WHERE ASST_ID = " + TDSMAN.Classes.TDSMAN.T_pFinancialYearId;
                else
                    strSQL = "SELECT SD_US_16_IA_LIMIT FROM MST_ASSESSMENT WHERE ASST_ID = " + TDSMAN.Classes.TDSMAN.T_pFinancialYearId;
            }
            else
            ...
            double dblUS16ia = Convert.ToDouble(Convert.ToString(dmlService.J_ExecSqlReturnScalar(strSQL)));
            //--
            if (cmnService.J_ReturnDoubleValue(txtDedTaxSection16ia.Text) > dblUS16ia)// TDSMAN.Classes.TDSMAN.T_US_16_IA_SD_MAX_LIMIT)
            {
                ErrProvider.SetError(txtDedTaxSection16ia, "Please check...\nMaximum amount limited to " + string.Format("{0:0.00}", Convert.ToDouble(dblUS16ia)));// TDSMAN.Classes.TDSMAN.T_US_16_IA_SD_MAX_LIMIT)));
            }
            else
        ...
        {
            if (cmnService.J_ReturnDoubleValue(txtSec80TTA1819DeductibleAmount.Text) > dblMAXTotalDeductibleAmount80TTA)
            {
                ErrProvider.SetError(txtSec80TTA1819DeductibleAmount, "Please check...\nMaximum amount limited to " + string.Format("{0:0.00}", dblMAXTotalDeductibleAmount80TTA));
            }
            else
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (lblMode.Text == J_Mode.Edit)
                        strSQL = strSQL + "AND TRN_SALARY_DETAILS.EMPLOYEE_ID <> " + cmnService.J_ReturnInt32Value(txtEmployeeID.Text);
                    //--
                    if (cmnService.J_NullToZero(dmlService.J_ExecSqlReturnScalar(strSQL)) > 0 && blMessage==false)
                    {
                    ...
                    if (TDSMAN.Classes.TDSMAN.T_pFinancialYearId >= T_FinancialYearID.F2013_14ID)
                    {
                        ...
                        if (TDSMAN.Classes.TDSMAN.T_pFinancialYearId >= T_FinancialYearID.F2024_25ID)
                        {
                            if (cmnService.J_ReturnDoubleValue(txtTotalTDSDedcuted.Text) != cmnService.J_ReturnDoubleValue(lblTotalBreakupTdsTcs.Text))//--(cmnService.J_ReturnDoubleValue(txtTotalTaxDeductedAmt.Text) + cmnService.J_ReturnDoubleValue(txtPreviousTaxDeductedAmt.Text) + cmnService.J_ReturnDoubleValue(txtUs192_2B.Text)))
                            {
                                cmnService.J_UserMessage("Sum of Current, Previous Employer's & Other TDS/TCS should be equal to Total TDS Deducted.");
                                txtTotalTaxDeductedAmt.Select();
                                return false;
                            }
                        }
                    ...
                    if (cmnService.J_ReturnDoubleValue(txtTaxableAmount.Text) > 0)
                    {
                        ...
                        double dblTaxonTotalIncomeB4TaxCredit = 0, dblTaxonTotalIncomeB4TaxCreditMarginalRelief=0, dblOtherTDSTCSSection192_2B=0;
                        double dblShortfall = cmnService.J_ReturnDoubleValue(lblShortfall.Text);
                        if (dblShortfall < 0) dblShortfall = 0;
                        //--
                        ...
                        if (Convert.ToInt32(TDSMAN.Classes.TDSMAN.T_pFinancialYearId) >= T_FinancialYearID.F2023_24ID)
                        {
                            if (dblTaxonTotalIncomeB4TaxCreditMarginalRelief > 0)
                            {
                                ...
                                dblActualRebate = dblTaxonTotalIncomeB4TaxCreditMarginalRelief - dblTaxonTotalIncomeB4TaxCredit;
                            }
                        }
                        //-- ANIK @ 2015/04/17
                        dblTotalTaxTobePaid = (dblTaxTobePaid + dblCalculatedECess + dblCalculatedSurcharge)
                        ...
                        if (TDSMAN.Classes.TDSMAN.T_pFinancialYearId >= T_FinancialYearID.F2024_25ID)//-- 2025/01/17
                            dblOtherTDSTCSSection192_2B = cmnService.J_ReturnDoubleValue(txtUs192_2B.Text);
                        ////dblTaxPaid = cmnService.J_ReturnDoubleValue(dblCurrentEmpTDS - cmnService.J_ReturnDoubleValue(txtReliefUS89.Text) + dblPrevEmpTDS + dblTaxSuperannuationFund + dblOtherTDSTCSSection192_2B); //-- 2016/09/23
                        dblTaxPaid = cmnService.J_ReturnDoubleValue(dblCurrentEmpTDS + dblPrevEmpTDS + dblTaxSuperannuationFund + dblOtherTDSTCSSection192_2B); //-- 2016/09/23
                        double dblTaxPaid1 = cmnService.J_ReturnDoubleValue(dblCurrentEmpTDS - cmnService.J_ReturnDoubleValue(txtReliefUS89.Text) + dblPrevEmpTDS + dblTaxSuperannuationFund + dblOtherTDSTCSSection192_2B); //-- 2016/09/23
                        ...
                        if (dblTaxPaid < dblTotalTaxTobePaid)
                        {
                            ...
                            if (TDSMAN.Classes.TDSMAN.T_pFinancialYearId >= T_FinancialYearID.F2024_25ID)
                            {
                                if (cmnService.J_UserMessage("Please Note :\n\n" +
                                                              ...
                                                              "Other TDS/TCS - Section 192(2B)\t: " + string.Format("{0:0.00}", dblOtherTDSTCSSection192_2B) + "\n" +
                                                              ...
                                                              //"Short Deduction\t\t\t: " + string.Format("{0:0.00}", (dblTotalTaxTobePaid - dblTaxPaid1)) +
                                                              "Short Deduction\t\t\t: " + string.Format("{0:0.00}", dblShortfall) +
                                                              "\n\nAre you sure you want to continue ?", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == DialogResult.No)
                                    return false;
                            }
                            else
                            {
                                //-- ANIK @ 2022/01/17 -- Other TDS/TCS - Section 192(2B)
                                if (cmnService.J_UserMessage("Please Note :\n\n" +
                                                              "Current Employer's Salary\t\t: " + string.Format("{0:0.00}", dblCurrentEmpSalary) + "\n" +
                                                              "Previous Employer's Salary\t\t: " + string.Format("{0:0.00}", dblPrevEmpSalary) + "\n" +
                                                              "Taxable Income as per salary\t: " + string.Format("{0:0.00}", dblTaxableIncome) + "\n\n" +
                ...
                switch (lblMode.Text)
                {
                    ...
                    case J_Mode.Add:
                        ...
                        strSQL = "UPDATE TRN_SALARY_DETAILS SET " +
                                "        TDS_US_192_2B_AMOUNT      = " + cmnService.J_ReturnDoubleValue(txtUs192_2B.Text) + " ";
        ...
        private bool ShowRecord(long Id)
        {
            ...
            try
            {
                ...
                strSQL = "SELECT  TRN_SALARY_DETAILS.SALARY_DETAILS_ID               AS SALARY_DETAILS_ID," +
                    ...
                    "             TRN_SALARY_DETAILS.TDS_US_192_2B_AMOUNT                      AS TDS_US_192_2B_AMOUNT " +
                    "     FROM    TRN_SALARY_DETAILS," +
                    "             MST_EMPLOYEE " +
                    "     WHERE   TRN_SALARY_DETAILS.EMPLOYEE_ID       = MST_EMPLOYEE.EMPLOYEE_ID " +
                ...
                while (drdShowRecord.Read())
                {
                    ...
                    //-- 2024/12/27
                    txtUs192_2B.Text = string.Format("{0:0.00}", cmnService.J_ReturnDoubleValue(Convert.ToString(drdShowRecord["TDS_US_192_2B_AMOUNT"])));
                    //--
...
//            }
        ...
        {
            if (TDSMAN.Classes.TDSMAN.T_pFinancialYearId >= T_FinancialYearID.F2024_25ID) //-- 2024/08/20
            {
                if (chkTaxation115BAC.Checked == true)
                {
                    if (cmnService.J_ReturnDoubleValue(txtTotalSalaryBalance.Text) >= dblStandardDeduction2425NewRegime)
                        txtDedTaxSection16ia.Text = string.Format("{0:0.00}", dblStandardDeduction2425NewRegime);
                    else if (cmnService.J_ReturnDoubleValue(txtTotalSalaryBalance.Text) < dblStandardDeduction2425NewRegime)
                        txtDedTaxSection16ia.Text = string.Format("{0:0.00}", cmnService.J_ReturnDoubleValue(txtTotalSalaryBalance.Text));
                    else
                        txtDedTaxSection16ia.Text = "0.00";
                }
                else
                {
                    if (cmnService.J_ReturnDoubleValue(txtTotalSalaryBalance.Text) >= dblStandardDeduction2425OldRegime)
                        txtDedTaxSection16ia.Text = string.Format("{0:0.00}", dblStandardDeduction2425OldRegime);
                    else if (cmnService.J_ReturnDoubleValue(txtTotalSalaryBalance.Text) < dblStandardDeduction2425OldRegime)
                        txtDedTaxSection16ia.Text = string.Format("{0:0.00}", cmnService.J_ReturnDoubleValue(txtTotalSalaryBalance.Text));
                    else
                        txtDedTaxSection16ia.Text = "0.00";
                }
            }
            else  if (TDSMAN.Classes.TDSMAN.T_pFinancialYearId >= T_FinancialYearID.F2019_20ID)
            {
        ...
        #region SetMaskedTextBoxSelectAll
        ...
        #region chkOptOut115BAC_1A_CheckedChanged
        ...
        #region chkOptOut115BAC_1A_Leave
        ...
        #region lblTaxOnTotalIncomeCalculated_TextChanged
        private void lblTaxOnTotalIncomeCalculated_TextChanged(object sender, EventArgs e)
        {
            chkPopulateCalculation_CheckedChanged(sender, e);
        }
        #endregion

        #region TxtUs192_2B_KeyPress
        private void TxtUs192_2B_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (Convert.ToInt64(e.KeyChar) == 13) SendKeys.Send("{tab}");
            if (mainVB.gTextBoxValidation(Convert.ToInt16(e.KeyChar), "N,12,2", txtUs192_2B, "") == false)
                e.Handled = true;
        }
        #endregion

        #region TxtUs192_2B_Leave
        private void TxtUs192_2B_Leave(object sender, EventArgs e)
        {
            TextBox txtBox = (TextBox)sender;
            if (txtBox.Text == "." || txtBox.Text == "") txtBox.Text = "0.00";
            txtBox.Text = string.Format("{0:0.00}", Convert.ToDouble(cmnService.J_NumericData(txtBox)));
        ...
        #region TxtUs192_2B_TextChanged
        private void TxtUs192_2B_TextChanged(object sender, EventArgs e)
        {
            //-- 2024/12/30
            if (TDSMAN.Classes.TDSMAN.T_pFinancialYearId >= T_FinancialYearID.F2024_25ID)
            {
        ...
        #region LnkCheckInOtherRegime_LinkClicked
        private void LnkCheckInOtherRegime_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            {                
                //--
                if (chkOptOut115BAC_1A.Checked == true) //-- OLD REGIME
                {
                    //-- CALCULATE AS PER NEW REGIME --
                    //
                    dblGrossSal = Convert.ToDouble(lblTotalGS.Text);
                    dblPreviousEmpSal = Convert.ToDouble(txtReportedTaxableAmount.Text);
                    //-- SECTION 10
                    if (TDSMAN.Classes.TDSMAN.T_pFinancialYearId >= T_FinancialYearID.F2023_24ID)
                        dblSection10Amt = cmnService.J_ReturnDoubleValue(txtSec10DeathCumRetirement.Text) +
                                             cmnService.J_ReturnDoubleValue(txtSec10CommutedValuePension.Text) +
                                             cmnService.J_ReturnDoubleValue(txtSec10CashEquivalent.Text) +
                                             cmnService.J_ReturnDoubleValue(txtSec10OtherExemption.Text) +
                                             cmnService.J_ReturnDoubleValue(txtSec1014.Text);
                    ...
                    if (cmnService.J_ReturnDoubleValue(txtOtherIncomeAmt1.Text) < 0)
                        ...
                        dblOtherIncomeAmount1 = cmnService.J_ReturnDoubleValue(txtOtherIncomeAmt1.Text);
                    dblOtherIncome = dblOtherIncomeAmount1 + cmnService.J_ReturnDoubleValue(txtOtherIncomeAmt2.Text);
                    //-- CHAPTER VI-A
                    dblChapterVIA= cmnService.J_ReturnDoubleValue(txtSec80CCD21819DeductibleAmount.Text);
                    ...
                    //-- TAX CALCULATION
                    dblTax = TdsMan.CalculateIncomeTaxAmount(Convert.ToInt32(TDSMAN.Classes.TDSMAN.T_pFinancialYearId),
                                                            cmbEmployeeCategory.Text.Substring(0, 1),
                ...
                else if (chkOptOut115BAC_1A.Checked == false) //-- NEW REGIME
                {
                    ...
                    //
                    if (TDSMAN.Classes.TDSMAN.T_pFinancialYearId >= T_FinancialYearID.F2023_24ID)
                        dblSection10Amt = cmnService.J_ReturnDoubleValue(txtSec10TravelConcession.Text) +
                                                cmnService.J_ReturnDoubleValue(txtSec10DeathCumRetirement.Text) +
                                                cmnService.J_ReturnDoubleValue(txtSec10CommutedValuePension.Text) +
                                                cmnService.J_ReturnDoubleValue(txtSec10CashEquivalent.Text) +
                                                cmnService.J_ReturnDoubleValue(txtSec10HRA.Text) +
                    ...
                    if (TDSMAN.Classes.TDSMAN.T_pFinancialYearId >= T_FinancialYearID.F2024_25ID)
                        ...
                        strSQL = "SELECT SD_US_16_IA_LIMIT FROM MST_ASSESSMENT WHERE ASST_ID = " + TDSMAN.Classes.TDSMAN.T_pFinancialYearId;
                    dblStdDeduction = Convert.ToDouble(Convert.ToString(dmlService.J_ExecSqlReturnScalar(strSQL)));
                    dblSection16Amt = dblStdDeduction + cmnService.J_ReturnDoubleValue(txtDedEntAllowance.Text) + cmnService.J_ReturnDoubleValue(txtDedTaxEmployment.Text);
                    //-- OTHER INCOME
                    dblOtherIncome = cmnService.J_ReturnDoubleValue(txtOtherIncomeAmt1.Text) + cmnService.J_ReturnDoubleValue(txtOtherIncomeAmt2.Text);
                    //-- CHAPTER VI-A
                    dblChapterVIA = cmnService.J_ReturnDoubleValue(lblSecChVIATotalAmt.Text);
                    //-- TOTAL TAXABLE INCOME
                    dblCurrentEmpSal = dblGrossSal - dblSection10Amt;
                    dblTotalTaxableIncome = (dblCurrentEmpSal + dblPreviousEmpSal) + dblOtherIncome - dblStdDeduction - dblChapterVIA;
                    //-- TAX CALCULATION
                ...
                //--
                if (dblTotalTaxableIncome < 0) dblTotalTaxableIncome = 0;
                //--
                //TrnTaxRegimeComparisonView objTrnTaxRegimeComparison = new TrnTaxRegimeComparisonView(txtFinancialYear.Text,
                //                                                                                 cmbEmployeeCategory.Text,
                //                                                                                 strRegime,
                //                                                                                 dblGrossSal,
                //                                                                                 dblCurrentEmpSal,
                //                                                                                 dblPreviousEmpSal,
                //                                                                                 dblOtherIncome,
                //                                                                                 dblCurrentEmpSal + dblPreviousEmpSal + dblOtherIncome,
                //                                                                                 dblSection10Amt,
                //                                                                                 dblSection16Amt,
                //                                                                                 dblChapterVIA,
                //                                                                                 dblTotalTaxableIncome,
                //                                                                                 dblTax,
                //                                                                                 dblCalculatedSurcharge,
                //                                                                                 dblCalculatedECess,
                //                                                                                 dblTax + dblCalculatedSurcharge + dblCalculatedECess);
                //objTrnTaxRegimeComparison.ShowDialog();
            }
            catch(Exception ERR)
            {
        ...
        #region BtnCompareRegime_Click
        private void BtnCompareRegime_Click(object sender, EventArgs e)
        {
            try
            {
                if (dgcViewSalaryDetails.CurrentRow.Index >= 0)
                {
                    ...
                    dmlService.J_Commit();
                    //--
                    cmnService.J_ShowChildForm(new TrnTaxRegimeCalculation(lngBasicInfoID, TDSMAN.Classes.TDSMAN.T_pFinancialYearId, txtFinancialYear.Text, txtCompany.Text, TDSMAN.Classes.TDSMAN.T_pTAN), J_Var.frmMain, "Regime Wise Tax Calculation");
                    //--------------------------------------------------
                }
                else
                {
        ...
        #region LnkImportant_LinkClicked
        private void LnkImportant_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            SysF24QSDMessage objSysF24QSDMessage = new SysF24QSDMessage();
            objSysF24QSDMessage.ShowDialog();
        }
        #endregion

        

        #region txtSec80TTA1819DeductibleAmount_TextChanged
        private void txtSec80TTA1819DeductibleAmount_TextChanged(object sender, EventArgs e)
        {
            //-- 2024/08/20
            if (cmnService.J_ReturnDoubleValue(txtSec80TTA1819DeductibleAmount.Text) > dblMAXTotalDeductibleAmount80TTA)
            {
                ErrProvider.SetError(txtSec80TTA1819DeductibleAmount, "Please check...\nMaximum amount limited to " + string.Format("{0:0.00}", dblMAXTotalDeductibleAmount80TTA));
                txtSec80TTA1819DeductibleAmount.Text = string.Format("{0:0.00}", dblMAXTotalDeductibleAmount80TTA);
            }
            //else if (cmnService.J_ReturnDoubleValue(txtSec80TTA1819DeductibleAmount.Text) <= dblMAXTotalDeductibleAmount80TTA)
            //    ErrProvider.SetError(txtSec80TTA1819DeductibleAmount, "");
            //--
            if (chkTaxation115BAC.Checked == true)
                lblSecChVIATotalAmt.Text = string.Format("{0:0.00}", cmnService.J_ReturnDoubleValue(txtSec80CCD21819DeductibleAmount.Text));
