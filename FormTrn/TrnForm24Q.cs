...
namespace TDSMAN.FormTrn
{
    ...
    public partial class TrnForm24Q : TDSMAN.FormGen.GenForm
    {
        ...
        #region TrnForm24Q_Activated
        private void TrnForm24Q_Activated(object sender, EventArgs e)
        {
                    ...
                    if (lblSearchMode.Text == Tabbed_Mode.Basic)
                    {
                        ...
                        if (TDSMAN.Classes.TDSMAN.T_pBookMarkOption == true)
                        {
                            ...
                            if (dmlService.J_IsRecordExist("MST_BOOKMARK_DETAIL", strQuery) == true)
                            {
                                ...
                                intAsstId = TdsMan.T_BookMarkDetail(T_TransactionMode.UPDATE.ToString(),
                            ...
                            else
                            {
                                ...
                                intAsstId = TdsMan.T_BookMarkDetail(T_TransactionMode.INSERT.ToString(),
                                                                    Convert.ToInt32(Support.GetItemData(cmbFinancialYear, cmbFinancialYear.SelectedIndex)),
                                                                    cmbQuarter.Text,
                                                                    strFormNo,
                                                                    Convert.ToInt32(Support.GetItemData(cmbCompany, cmbCompany.SelectedIndex)),
                        ...
                        #region LICENSED_VERSION
//                        else if (TDSMAN.Classes.TDSMAN.T_pVersionType == T_VERSION_TYPE.LICENSED_VERSION)
//                        {
//                            strSQL = @"SELECT COUNT(DEDUCTEE_DETAIL_ID) AS COUNT_DEDUCTEE_DETAIL_COUNT 
...
//                                           AND    MST_ASSESSMENT.ASST_ID             = (SELECT MAX(ASST_ID) FROM MST_ASSESSMENT)";
                                
//                            #region PROFESSIONAL_EDITION
//                            if (TDSMAN.Classes.TDSMAN.T_pEditionType == T_EDITION_TYPE.PROFESSIONAL_EDITION)
//                            {
//                                if (cmnService.J_NullToZero(dmlService.J_ExecSqlReturnScalar(strSQL)) > TDSMAN.Classes.TDSMAN.T_MaxDeducteeDetailsCountEditions)
//                                {
//                                    TrnTrialMessageBox TrialMessageBox = new TrnTrialMessageBox();
//                                    TrialMessageBox.StartPosition = FormStartPosition.CenterScreen;
//                                    TrialMessageBox.lblMessage1.Visible = false;
//                                    TrialMessageBox.lnkOrderNow.Visible = false;
//                                    TrialMessageBox.lblMessage2.Text = "Return cannot be generated as the Professional version supports only " + TDSMAN.Classes.TDSMAN.T_MaxDeducteeDetailsCountEditions + " nos. of employee records in total.";
//                                    TrialMessageBox.Show();
//                                    return;
//                                }
//                            }
...
//                                    TrialMessageBox.lblMessage1.Visible = false;
//                                    TrialMessageBox.lnkOrderNow.Visible = false;
//                                    TrialMessageBox.lblMessage2.Text = "Return cannot be generated as the trial Standard version supports only " + TDSMAN.Classes.TDSMAN.T_MaxDeducteeDetailsCountEditions + " nos. of employee records in total.";
//                                    TrialMessageBox.Show();
//                                    return;
//                                }
//                            }
...
//                        }
                        ...
                        #region PUBLICATION_HOUSE_VERSION
        ...
        private void cmbMain_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (LoadBasicDetails(Convert.ToInt32(Support.GetItemData(cmbCompany, cmbCompany.SelectedIndex)), lngBasicInfoID) == true)
            {
                ...
                ////
                //if(strPrevTokenNo != "" && txtPrevTokenNo.Text == "")
        ...
        private void btnChallanEntry_Click(object sender, EventArgs e)
        {
            ...
            //-----------
            if (txtDeductorType.Text.Substring(0, 1) == "A" ||
                txtDeductorType.Text.Substring(0, 1) == "S" ||
                txtDeductorType.Text.Substring(0, 1) == "D" ||
                txtDeductorType.Text.Substring(0, 1) == "E" ||
                txtDeductorType.Text.Substring(0, 1) == "G" ||
                txtDeductorType.Text.Substring(0, 1) == "H" ||
                txtDeductorType.Text.Substring(0, 1) == "L" ||
                txtDeductorType.Text.Substring(0, 1) == "N")
        ...
        private void btnGenerateReturns_Click(object sender, EventArgs e)
        {
            ...
            //
            //Added by Shrey Kejriwal on 01/04/2014
        ...
        #region TrnForm24Q_FormClosing
        private void TrnForm24Q_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private bool ShowChallanDetailsRecord(long Id)
        {
            ...
            try
            {
                ...
                //----------------------------------------------------------------------------
                //BLOCKED BY DHRUB ON 08/01/2013 TO ADD DEDUCTION OF LATE_FEE FOR CHALLAN 
                //----------------------------------------------------------------------------
                //strSQL = "SELECT TRN_CHALLAN.CHALLAN_ID          AS CHALLAN_ID," +
                //    "            TRN_CHALLAN.SL_NO               AS SL_NO," +
                //    "            TRN_CHALLAN.SECTION_ID          AS SECTION_ID," +
                ...
                //------------------------------------------------------------------
                //MODIFIED BY DHRUB ON 08/01/2014 FOR DEDUCTION OF FEE FOR CHALLAN
                //------------------------------------------------------------------
                //------------------------------------------------------------------
                strSQL = "SELECT TRN_CHALLAN.CHALLAN_ID          AS CHALLAN_ID," +
                    "            TRN_CHALLAN.SL_NO               AS SL_NO," +
        ...
        private bool ValidateFields()
        {
            try
            {
                ...
                else if (lblSearchMode.Text == Tabbed_Mode.Challan)
                {
                    ...
                    //---------------------------------------------------------------
                    //-- VALID DATE CHECK FOR BOOKMARK ADDED BY DHRUB ON 08/01/2014
                    //---------------------------------------------------------------
                    if(chkBookEntry.Checked == true)
                    {
                ...
                else if (lblSearchMode.Text == Tabbed_Mode.Deductee)
                {
                    ...
                    {
                        cmnService.J_UserMessage("Employee PAN - Cannot be Blank");
                        txtDeducteePAN.Select();
                        return false;
                    }
                    ...
                    if (Convert.ToDouble(txtDeducteeTotal.Text) != 0)
                    {
                        ...
                        //VALID DATE CHECK
                        if (dtService.J_ConvertToIntYYYYMMDD(mskDeductedDate.Text) < dtService.J_ConvertToIntYYYYMMDD(TdsMan.T_ReturnStartDateFinancialYear(cmbFinancialYear.Text)))
                        {
                    ...
                    //{
                        ...
                        if (Support.GetItemData(cmbFinancialYear, cmbFinancialYear.SelectedIndex) >= T_FinancialYearID.F2010_11ID)
                        {
                            if (txtDeducteePAN.Text == "PANNOTAVBL" && Convert.ToInt32(Support.GetItemData(cmbRemarks, cmbRemarks.SelectedIndex)) != 3)//&& rbnHigherRate.Checked == false)
                            {
                        ...
                        if (Convert.ToInt32(Support.GetItemData(cmbRemarks, cmbRemarks.SelectedIndex)) == 3 && txtDeducteePAN.Text != "PANNOTAVBL")
                        {
                    ...
                    if (cmbRemarks.SelectedIndex > 0)
                    {
                        if (Convert.ToDouble(txtDeducteeTotal.Text) == 0 && Convert.ToInt32(Support.GetItemData(cmbRemarks, cmbRemarks.SelectedIndex)) == 4)
                        {
                ...
                switch (lblMode.Text)
                {
                    ...
                    case J_Mode.Edit:
                        ...
                        if (lblSearchMode.Text == Tabbed_Mode.Challan)
                        {
                            ...
                            //-----------------------------------------------------------
                            //-----------------------------------------------------------
                            //BLOCKED BY DHRUB ON 08/01/2014 FOR ADD THE FEE
                            //-----------------------------------------------------------
                            ...
                            //-----------------------------------------------------------------------------
                            //-- CHALLAN NO. VALIDATION ADDED BY DHRUB ON 08/01/2014 FOR DEDUCTION OF FEE
                            //-----------------------------------------------------------------------------
                            if (chkBookEntry.Checked == false)
                            {
                                strSQL = "SELECT COUNT(*) FROM TRN_CHALLAN " +
                            ...
                            //------------------------------------------------------------------------------
                            //-- TRANSFER VOUCHER NO. ADDED BY DHRUB ON 08/01/2014 FOR NON DEDUCTION OF FEE
                            //------------------------------------------------------------------------------
                            if (chkBookEntry.Checked == true)
                            {
                                strSQL = "SELECT COUNT(*) FROM TRN_CHALLAN " +
        ...
        private void LoadChallanGrid(long BasicInfoID)
        {
            ...
            //-----------------------------------------------------------------
            //ADDED BY DHRUB ON 08/01/2014 TO DEDUCT LATE_FEE FOR CHALLAN 
            //-----------------------------------------------------------------
            //-----------------------------------------------------------------
            string[,] strLoadChallanTotTaxMatrix = {{"TRN_CHALLAN.CHALLAN_NO = ''", "F", "TRN_CHALLAN.TOT_TAX - TRN_CHALLAN.INTEREST_ALLOCATED - TRN_CHALLAN.OTHERS_ALLOCATED", "F"},
                                                    {"TRN_CHALLAN.TRANSFER_VOUCHER_NO = ''", "F", "TRN_CHALLAN.TOT_TAX - TRN_CHALLAN.INTEREST_ALLOCATED - TRN_CHALLAN.OTHERS_ALLOCATED- TRN_CHALLAN.LATE_FEE", "F"}};
            ...
            //------------------------------------------------------------------
            //--COMMENTED BY DHRUB ON 08/01/2014 
            //------------------------------------------------------------------
            //------------------------------------------------------------------
            ...
            //-----------------------------------------------------------------
            //MODIFIED BY DHRUB ON 08/01/2014 TO DEDUCT LATE_FEE FOR CHALLAN 
            //-----------------------------------------------------------------
            strOrderBy = "TRN_CHALLAN.CHALLAN_ID";
            strQuery = "SELECT TRN_CHALLAN.CHALLAN_ID          AS CHALLAN_ID," +
                      "       TRN_CHALLAN.SL_NO               AS SL_NO," +
        ...
        private void LoadChallanGrid(long BasicInfoID, object sender, EventArgs e)
        {
            ...
            //------------------------------------------------------------------
            //--BLOCKED EXISTING SQL BY DHRUB ON 08/01/2014 
            //------------------------------------------------------------------
            //------------------------------------------------------------------
            //strOrderBy = "TRN_CHALLAN.CHALLAN_ID";
            //strQuery = "SELECT TRN_CHALLAN.CHALLAN_ID          AS CHALLAN_ID," +
                    ...
                    for (long lngCounter = 0; lngCounter <= lngArrayCounter - 1; lngCounter++)
                    {
                        ...
                        while (drdGenDeductee.Read())
                        {
                            ...
                            cmnService.J_WriteLine(ref StreamWriter, TdsMan.T_WriteField(intPageNumber.ToString()) + TdsMan.T_WriteField("DD") + TdsMan.T_WriteField("1") +
                                            ...
                                            TdsMan.T_WriteBlankField(1, "^") +
                                            TdsMan.T_WriteField(TdsMan.RemoveSpecialCharacters(Convert.ToString(drdGenDeductee["EMPLOYEE_REF"]))) +
        ...
        private void EnabilityReturnFilingStatus(long BasicInfoId)
        {
            ...
            try
            {
                ...
                drdShowRecord = dmlService.J_ExecSqlReturnReader(dmlService.J_pCommand, strSQL);
                if (drdShowRecord == null)
                {
                    return;
                }
        ...
        private void LoadChallanFormComponents()
        {
            if (Support.GetItemData(cmbFinancialYear, cmbFinancialYear.SelectedIndex) <= T_FinancialYearID.F2012_13ID)
            {
                ...
                label57.Location = new Point(108, 32);
            ...
            else
            {
                ...
                lblMinor.Location = new Point(-8, 277);
                ...
                lblRemarks.Location = new Point(8, 301); //310
                txtRemarks.Location = new Point(68, 298); //307

                lblInterestAllocated.Location = new Point(43, 324);//341
                txtInterestAllocated.Location = new Point(164, 322);//337

                lblOthersAllocated.Location = new Point(49, 350);//362
                txtOthersAllocated.Location = new Point(164, 348);//359
        ...
        private string ReturnGeneratedForm27APath()
        {
            ...
            string str27APdfFileName = "27A_" + txtTAN.Text + "_" + T_FormNo.F24Q + "_" + cmbQuarter.Text + "_" + cmbFinancialYear.Text.Replace("-", "") + ".pdf";
