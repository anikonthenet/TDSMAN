...
{
    public partial class UtlImportfromPrevYearDB_Restore : TDSMAN.FormGen.GenForm
    {
        #region System Generated Code
        public UtlImportfromPrevYearDB_Restore()
        {
            InitializeComponent();
        }
        #endregion
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            //ONLY RESTORING THE DATABASE AS THE IMPORT OPTION NEED TO BE IMPROVED
            int intCount;

            strSQL = "SELECT COUNT(*) FROM COR_HDR_BATCH ";
            intCount = Convert.ToInt32(dmlService.J_ExecSqlReturnScalar(strSQL));

            strSQL = "SELECT COUNT(*) FROM TRN_BASIC_INFO";
            intCount = intCount + Convert.ToInt32(dmlService.J_ExecSqlReturnScalar(strSQL));

            if (cmnService.J_UserMessage("Are you sure you want to import the data from the database selected?", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) == DialogResult.No)
                return;

            if (intCount > 0)
            {
                //RECORDS EXISTS IN THE CURRENT DATABASE

                if (cmnService.J_UserMessage("Please Note: Your existing database is having data which will be Replaced after the import.\nDo you still want to continue with the import?", MessageBoxButtons.YesNo, MessageBoxIcon.Error, MessageBoxDefaultButton.Button2) == DialogResult.No)
                    return;

            }

            //now only restoring the database
            ...
            //deleteing all the data from the destination table and importing data from the source table

            strSQL = "DELETE FROM COR_HDR_BATCH";
            dmlService.J_ExecSql(strSQL);
            strSQL = "INSERT INTO COR_HDR_BATCH SELECT * FROM TEMP_COR_HDR_BATCH";
            dmlService.J_ExecSql(strSQL);
            strSQL = "DROP TABLE TEMP_COR_HDR_BATCH";
            dmlService.J_ExecSql(strSQL);
            ...
            dmlService.J_ExecSql(strSQL);
            strSQL = "INSERT INTO COR_HDR_CHALLAN SELECT * FROM TEMP_COR_HDR_CHALLAN";
            dmlService.J_ExecSql(strSQL);
            strSQL = "DROP TABLE TEMP_COR_HDR_CHALLAN";
            dmlService.J_ExecSql(strSQL);
            
            strSQL = "DELETE FROM COR_HDR_COMPANY";
            dmlService.J_ExecSql(strSQL);
            strSQL = "INSERT INTO COR_HDR_COMPANY SELECT * FROM TEMP_COR_HDR_COMPANY";
            dmlService.J_ExecSql(strSQL);
            strSQL = "DROP TABLE TEMP_COR_HDR_COMPANY";
            dmlService.J_ExecSql(strSQL);
            
            strSQL = "DELETE FROM COR_HDR_DEDUCTEE_DETAILS";
            dmlService.J_ExecSql(strSQL);
            strSQL = "INSERT INTO COR_HDR_DEDUCTEE_DETAILS SELECT * FROM TEMP_COR_HDR_DEDUCTEE_DETAILS";
            dmlService.J_ExecSql(strSQL);
            strSQL = "DROP TABLE TEMP_COR_HDR_DEDUCTEE_DETAILS";
            dmlService.J_ExecSql(strSQL);
            
            strSQL = "DELETE FROM COR_HDR_SALARY_DETAILS";
            dmlService.J_ExecSql(strSQL);
            strSQL = "INSERT INTO COR_HDR_SALARY_DETAILS SELECT * FROM TEMP_COR_HDR_SALARY_DETAILS";
            dmlService.J_ExecSql(strSQL);
            strSQL = "DROP TABLE TEMP_COR_HDR_SALARY_DETAILS";
            dmlService.J_ExecSql(strSQL);
            
            strSQL = "DELETE FROM COR_TRN_CHALLAN";
            dmlService.J_ExecSql(strSQL);
            strSQL = "INSERT INTO COR_TRN_CHALLAN SELECT * FROM TEMP_COR_TRN_CHALLAN";
            dmlService.J_ExecSql(strSQL);
            strSQL = "DROP TABLE TEMP_COR_TRN_CHALLAN";
            dmlService.J_ExecSql(strSQL);
            

            strSQL = "DELETE FROM COR_TRN_COMPANY";
            dmlService.J_ExecSql(strSQL);
            strSQL = "INSERT INTO COR_TRN_COMPANY SELECT * FROM TEMP_COR_TRN_COMPANY";
            dmlService.J_ExecSql(strSQL);
            strSQL = "DROP TABLE TEMP_COR_TRN_COMPANY";
            dmlService.J_ExecSql(strSQL);
            
            strSQL = "DELETE FROM COR_TRN_DEDUCTEE_DETAILS";
            dmlService.J_ExecSql(strSQL);
            strSQL = "INSERT INTO COR_TRN_DEDUCTEE_DETAILS SELECT * FROM TEMP_COR_TRN_DEDUCTEE_DETAILS";
            dmlService.J_ExecSql(strSQL);
            strSQL = "DROP TABLE TEMP_COR_TRN_DEDUCTEE_DETAILS";
            dmlService.J_ExecSql(strSQL);
            
            strSQL = "DELETE FROM COR_TRN_SALARY_DETAILS";
            dmlService.J_ExecSql(strSQL);
            strSQL = "INSERT INTO COR_TRN_SALARY_DETAILS SELECT * FROM TEMP_COR_TRN_SALARY_DETAILS";
            dmlService.J_ExecSql(strSQL);
            strSQL = "DROP TABLE TEMP_COR_TRN_SALARY_DETAILS";
            dmlService.J_ExecSql(strSQL);
            
            strSQL = "DELETE FROM MST_COMPANY";
            dmlService.J_ExecSql(strSQL);
            ...
            strSQL = "DELETE FROM TRN_BASIC_INFO";
            dmlService.J_ExecSql(strSQL);
            ...
            strSQL = "DELETE FROM TRN_COMPANY_INFO";
            dmlService.J_ExecSql(strSQL);
