...
namespace TDSMAN.FormTrnCalcMonthlyTDS
{
    public partial class TrnSDCalcTDS : TDSMAN.FormGen.GenForm
    {
        ...
        private void ClearControls()
        {
            ...
            //--
            string[] strQtr = { T_YES_NO.YES, T_YES_NO.NO };
            dmlService.J_PopulateComboBox(strQtr, ref cmbSection115BAC, 1);
            //
            txtAnnualGrossSalary.Text = "0.00";
            txtProfessionalTax.Text = "0.00";
            txtDeductionus10.Text = "0.00";
        ...
        private void ViewGrid_Navigate(object sender, NavigateEventArgs ne)
        {
