...
namespace TDSMAN.Classes
{
    ...
    public enum J_SQLColFormat
    {
        ...
        ConvertToString,
        Others,
        DateTimeFormatDDMMYYYYHHMMSSNumeric
    }
    #endregion
    ...
    #region J_IndexDropType
    public enum J_IndexDropType
    {
        Individual,
        All
    }
    ...
    #region J_DateTimeType
    public enum J_DateTimeType : uint
    {
        DAY,
        MONTH,
        YEAR,
    ...
    #region J_Display_Paisa
    public enum J_Display_Paisa
    {
        DISP_BEFORE,
        DISP_AFTER
    }
    ...
    public struct J_Msg
    {
        ...
        public const string ContactSWVendor    = "Please contact to software vendor to get this process.";
        public const string SystemMaintenance  = "Please run the system maintenance.";
    }
    #endregion
    ...
    public struct J_Mode
    {
        ...
        public const string Printing    = "Print Mode";
        public const string Saving      = "Save Mode";
    }
    #endregion
    ...
    public sealed class J_Var
    {
        ...
        #region PUBLIC OBJECTS declaration

        //~~~~ Declare global object of MDI main ~~~~
        public static mdiTDSMAN frmMain;
        ...
        private static string DBPath = "";     //added by indrajit on 11-02-2013
        private static string EnterpriseServerPath = "";
        ...
        private static string SQLDatabasePassword = "";
        ...
        private static J_ExportType enmExportType                         = J_ExportType.FullTable;

        private static string XmlMsAccessScriptFileName                   = "msaccess-script.xml";
        private static string XmlSqlServerScriptFileName                  = "sqlserver-script.xml";
        ...
        #region EXPORT TYPE
        public static J_ExportType J_pExportType
        {
            get
            {
                return enmExportType;
            }
            set
            {
                enmExportType = (J_ExportType)value;
            }
        }
        #endregion

        #region EXPORT BATCH NO.
        public static long J_pExportBatchNo
        {
            get
            {
        ...
        #region SQL DATABASE PASSWORD //-- 2016/01/30
        public static string J_pSQLDatabasePassword
        {
            get
            {
        ...
        #region SERVER DATE
        public static string J_pServerDate
        {
            get
            {
                return ServerDate;
        ...
        #region J_pDBPath
        public static string J_pDBPath
        {
            get
            {
                return DBPath;
        ...
        #region J_pEnterpriseServerPath
        public static string J_pEnterpriseServerPath
        {
            get
            {
                return EnterpriseServerPath;
            }
            set
            {
                EnterpriseServerPath = value;
            }
        }
        #endregion

        #region XML MS ACCESS SCRIPT FILE NAME
        public static string J_pXmlMsAccessScriptFileName
        {
            get
            {
                return XmlMsAccessScriptFileName;
            }
            set
            {
                XmlMsAccessScriptFileName = value;
            }
        }
        #endregion

        #region XML SQL SERVER SCRIPT FILE NAME
        public static string J_pXmlSqlServerScriptFileName
        {
            get
            {
                return XmlSqlServerScriptFileName;
            }
            set
            {
                XmlSqlServerScriptFileName = value;
            }
        }
        #endregion


        #region HEAD OFFICE BRANCH ID
        public static long J_pHOBranchId
        {
            get
            {
                return HOBranchId;
