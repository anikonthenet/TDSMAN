    ...
    public class TracesConnect
    {
        ...
        public TracesResponse RequestForDownloadFile(string strReqNo, string strPath)
        {
            ...
            try
            {
                ...
                if (Regex.IsMatch(strResponse, "downloadmultiple.xhtml?"))
                {
        ...
        public TracesResponse RequestForJustificationReportDownload(TracesLogin objLogin, TracesData objTraceData)
        {
            ...
            try
            {
                ...
                //MODIFIED ON 22-12-2014 AS PER NEW PAGE UPDATED IN TRACES SITE. START SECTION
        ...
        public string ChallanStatusQuery(ChallanQuery objData)
        {
            try
            {
                ...
                string strResponse = makeHTTPPostRequest("https://tin.tin.nsdl.com/oltas/servlet/TanSearch", sbParameter);
                string strPageName = HTMLTagAttributeValue(strServerResponse, "//form[@name=\"TanSearch\"]", "action");
                ...
                Dictionary<string, string> objNameval = TraceHiddenField(strResponse, "//form[@name=\"TanSearch\"]");
                ...
                foreach (KeyValuePair<string, string> pair in objNameval)
                {
                    ...
                    string strCurrVal = pair.Key.Substring(pair.Key.LastIndexOf("_") + 1);
                    int intOut;
                    if (int.TryParse(strCurrVal, out intOut))
                    {
                        // if (strLastVal != strCurrVal)
                        if (objData.ChallanNo == pair.Value)
                        {
