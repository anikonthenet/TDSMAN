...
namespace TDSMAN.Classes
{
    ...
    public class ResizeForm
    {
        ...
        public void _resize() //Set the resize
        {
            try {
                ...
                foreach (Control control in _controls)
                {
                    ...
                    //if ((int)_arr_control_storage[_pos].Width > 0 && (int)_arr_control_storage[_pos].Height > 0)
                    //{
                    ...
                    //
                    //Font AutoSize
                    //if (control.Name != "lstDeducteeHelp" && control.Name != "lstDeducteePANHelp" && control.Name != "lstDeducteeNameHelp")
                    //{
                        //control.Font = new System.Drawing.Font(form.Font.FontFamily,
                        // (float)(((Convert.ToDouble(_fontsize) * _form_ratio_width) / 2) +
                        //  ((Convert.ToDouble(_fontsize) * _form_ratio_height) / 2)), control.Font.Style); 
                        //-- 2023/02/14
        ...
        public void _dgv_Column_Adjust(DataGridView dgv, bool _showRowHeader) //if you have Datagridview 
