...
namespace TDSMAN.Classes
{
    public class DMLService : IDisposable
    {
        ...
        #region PRIVATE OBJECTS declaration
        ...
        //--
        private string strErrFile = "GETERR.ERR";
        ...
        private bool J_OpenConnection()
        {
            ...
            if (this.enmApplicationType == J_ApplicationType.StandAlone_Network)
            {
                if ((this.J_strConnectionString == null) || (this.J_strConnectionString.Trim().Length == 0))
                    this.J_strConnectionString = string.Empty;
                //-- 2016/01/30
                if (TDSMAN.T_pEditionType == T_EDITION_TYPE.ENTERPRISE_EDITION || TDSMAN.T_pEditionType == T_EDITION_TYPE.ENTERPRISE_LITE_EDITION || TDSMAN.T_pEditionType == T_EDITION_TYPE.ENTERPRISE_ULTIMATE_EDITION)
                    this.enmConnectionProviderType = J_ConnectionProviderType.Sql;
                //--
                this.J_strConnectionString = J_GetConnectionString(this.enmApplicationType);
                //MessageBox.Show(this.J_strServerName + "/" + this.J_strUserName + "/" + this.J_strPassword + "/" + this.J_strDataBase);
                //this.J_strServerName = "TDSMAN";
                return this.J_OpenConnection(this.J_strServerName, this.J_strUserName, this.J_strPassword, this.J_strDataBase);
                //MessageBox.Show(this.J_strServerName.ToString() + " " + this.J_strUserName.ToString() + " " + this.J_strPassword.ToString() + " " + this.J_strDataBase.ToString());
            }
        ...
        private bool J_OpenConnection(J_ApplicationType ApplicationType)
        {
            ...
            catch(Exception ERR)
            {
                ...
                if (File.Exists(Path.Combine(Application.StartupPath, strErrFile)) == true)
                    commonservice.J_UserMessage(ERR.Message);
                else
                ...
                if (this.enmDatabaseType == J_DatabaseType.SqlServer)
                {
                    ...
                    //}
                        ...
                        if (this.enmConnectionProviderType == J_ConnectionProviderType.Sql)
                        {
                            ...
                            //-- 2018/05/11
                            ////this.J_strADODBConnectionString = "Provider=SQLNCLI10;Server =" + this.J_strServerName + "/SQLEXPRESS; Database =" + this.J_strDataBase + "";
                        }
                    if (this.enmConnectionProviderType == J_ConnectionProviderType.OleDb)
                        this.J_strADODBConnectionString = "Provider=SQLOLEDB.1;Persist Security Info=False;Initial Catalog=" + this.J_strDataBase + ";Data Source=" + this.J_strServerName + ";Pooling=false";
                }
        ...
        #region J_OpenConnection [5]
        public bool J_OpenConnectionBkUp(string MSAccessDatabaseNameWithPath)
        {
            return this.J_OpenConnection(MSAccessDatabaseNameWithPath, null);
        }
        #endregion
        ...
        {
            int intNoOfRow = 0;
            return this.ExportFileEngine(ExportFolderPath, FileType, SourceTableName, "*", null, Delimiter, TextQualifier, false, null, out intNoOfRow);
        }
        #endregion
        ...
        {
            int intNoOfRow = 0;
            return this.ExportFileEngine(ExportFolderPath, FileType, SourceTableName, ExportColumns, null, Delimiter, TextQualifier, false, null, out intNoOfRow);
        }
        #endregion
        ...
        {
            int intNoOfRow = 0;
            return this.ExportFileEngine(ExportFolderPath, FileType, SourceTableName, ExportColumns, Criteria, Delimiter, TextQualifier, false, null, out intNoOfRow);
        }
        #endregion
        ...
        {
            int intNoOfRow = 0;
            return this.ExportFileEngine(ExportFolderPath, FileType, SourceTableName, ExportColumns, Criteria, Delimiter, TextQualifier, Header, null, out intNoOfRow);
        }
        #endregion

        #region ExportFileEngine [5]
        private bool ExportFileEngine(string ExportFolderPath, J_ExportFileType FileType, string SourceTableName, string ExportColumns, string Criteria, string Delimiter, string TextQualifier, bool Header, out int NoOfRow)
        {
            return this.ExportFileEngine(ExportFolderPath, FileType, SourceTableName, ExportColumns, Criteria, Delimiter, TextQualifier, Header, null, out NoOfRow);
        }
        #endregion

        #region ExportFileEngine [6]
        private bool ExportFileEngine(string ExportFolderPath, J_ExportFileType ExportFileType, string SourceTableName, string ExportColumns, string Criteria, string Delimiter, string TextQualifier, bool Header, string OrderBy, out int NoOfRow)
        {
            NoOfRow = 0;
            string strFileName = "";
                    ...
                    case J_DatabaseType.MsAccess:
                        switch (ExportFileType)
                        {
                            ...
                            case J_ExportFileType.TextFile:
                                ...
                                this.J_CreateSchemaFile(ExportFolderPath, SourceTableName, ExportColumns, Delimiter, TextQualifier, "MM/dd/yyyy", Header, OrderBy);
                                ...
                                if (OrderBy != null) strSQL += " ORDER BY " + OrderBy;
        ...
        public bool J_ExecSql(IDbCommand command, string SqlText, out int RowsAffected, J_SQLType SQLType)
        {
            ...
            {   
                //-- 2016/02/01
                SqlText = ReturnUpdateJoinSyntaxSequelServer(SqlText.Trim());
                //strSQL = "SELECT COUNT(*)" +
                //      "     FROM   TRN_DEDUCTEE_DETAILS " +
                //      "     WHERE  " + commonservice.J_SQLDBFormat("SL_NO", J_SQLColFormat.IsNumeric) + " = 0";
                //--                
                if (command == null)
                {
            ...
            catch(Exception ERR)
            {
                ...
                if (File.Exists(Path.Combine(Application.StartupPath, strErrFile)) == true)
                    ...
                    commonservice.J_UserMessage("Connection Failed", MessageBoxIcon.Stop);
                //commonservice.J_UserMessage(ERR.Message, MessageBoxIcon.Stop);
                //commonservice.J_UserMessage(SqlText);
                return false;
            }
        }
        #endregion
        ...
        public object J_ExecSqlReturnScalar(IDbCommand command, string SqlText)
        {
            ...
            catch(Exception err)
            {
                ...
                if (File.Exists(Path.Combine(Application.StartupPath, strErrFile)) == true)
                    ...
                    commonservice.J_UserMessage("Connection Failed", MessageBoxIcon.Stop);
                //commonservice.J_UserMessage(SqlText, MessageBoxIcon.Stop);                
                return null;
            }
        }
        #endregion
        ...
        #region POPULATE COMBO BOX [49]
        public bool J_PopulateComboBox(string TableName, string SqlText, ref ComboBox combobox, string valueMember, string displayMember)
        {
            return this.J_PopulateComboBox(TableName, SqlText, ref combobox, valueMember, displayMember, 0, "", J_ComboBoxDefaultText.YES);
        }
        #endregion

        #region POPULATE COMBO BOX [50]
        public bool J_PopulateComboBox(string TableName, string SqlText, ref ComboBox combobox, string valueMember, string displayMember, int SelectedIndex)
        {
            return this.J_PopulateComboBox(TableName, SqlText, ref combobox, valueMember, displayMember, SelectedIndex, "", J_ComboBoxDefaultText.YES);
        }
        #endregion

        #region POPULATE COMBO BOX [51]
        public bool J_PopulateComboBox(string TableName, string SqlText, ref ComboBox combobox, string valueMember, string displayMember, int SelectedIndex, J_ComboBoxDefaultText ComboBoxDefaultText)
        {
            return this.J_PopulateComboBox(TableName, SqlText, ref combobox, valueMember, displayMember, SelectedIndex, "", ComboBoxDefaultText);
        }
        #endregion

        #region POPULATE COMBO BOX [52]
        public bool J_PopulateComboBox(string TableName, string SqlText, ref ComboBox combobox, string valueMember, string displayMember, int SelectedIndex, string DefaultText, J_ComboBoxDefaultText ComboBoxDefaultText)
        {
            DataSet ds = null;
            ...
            try
            {
                ...
                if (ComboBoxDefaultText == J_ComboBoxDefaultText.NO) strSQL = SqlText;
                else if (ComboBoxDefaultText == J_ComboBoxDefaultText.YES)
                {
                    strSQL = "SELECT -1                   AS " + valueMember + "," +
                             "      '" + DefaultText + "' AS " + displayMember + " " +
                             "FROM   " + TableName + " " +
                             "UNION " +
                              SqlText;
                }

                ds = this.J_ExecSqlReturnDataSet(strSQL);
        ...
        public string J_ReturnServerDate(IDbCommand command, J_DatabaseType dbType)
        {
            switch (dbType)
            {
                case J_DatabaseType.SqlServer:
                    ...
                    //this.strSQL = "SELECT CONVERT(CHAR(10),GETDATE(),101)";
                    this.strSQL = "SELECT CONVERT(CHAR(20),GETDATE(),120)";
                    break;
        ...
        public string J_ReturnServerTime(IDbCommand command, J_DatabaseType dbType)
        {
            ...
            {
                case J_DatabaseType.SqlServer:
                    this.strSQL = "SELECT CONVERT(CHAR(8), GETDATE(), 108)";
                    break;
        ...
        {
            return this.J_DropIndex(TableName, null, J_IndexType.All, J_SQLType.DML, J_IndexDropType.Individual);
        }
        #endregion

        #region J_DropIndex [2]
        public bool J_DropIndex(J_IndexDropType IndexDropType, J_SQLType SQLType)
        {
            return this.J_DropIndex(null, null, J_IndexType.All, SQLType, IndexDropType);
        }
        #endregion

        #region J_DropIndex [3]
        public bool J_DropIndex(string TableName, J_SQLType SQLType)
        {
            return this.J_DropIndex(TableName, null, J_IndexType.All, SQLType, J_IndexDropType.Individual);
        }
        #endregion

        #region J_DropIndex [4]
        public bool J_DropIndex(string TableName, string IndexName)
        {
            return this.J_DropIndex(TableName, IndexName, J_IndexType.All, J_SQLType.DML, J_IndexDropType.Individual);
        }
        #endregion

        #region J_DropIndex [5]
        ...
        #region J_DropIndex [6]
        public bool J_DropIndex(string TableName, string IndexName, J_IndexType IndexType, J_SQLType SQLType)
        {
            return this.J_DropIndex(TableName, IndexName, J_IndexType.All, SQLType, J_IndexDropType.Individual);
        }
        #endregion

        #region J_DropIndex [7]
        public bool J_DropIndex(string TableName, string IndexName, J_IndexType IndexType, J_SQLType SQLType, J_IndexDropType IndexDropType)
        {
            ...
            if (IndexDropType == J_IndexDropType.All)
            {
                strSQL = @"SELECT COUNT(SYS.INDEXES.NAME) AS NO_OF_ROWS
                           FROM   SYSOBJECTS,
                                  SYS.INDEXES
                           WHERE  SYSOBJECTS.ID     = SYS.INDEXES.OBJECT_ID
                ...
                strArray = new string[intRowCount];
                strSQL = @"SELECT SYSOBJECTS.NAME  AS TABLE_NAME,
                                  SYS.INDEXES.NAME AS INDEX_NAME,
                                 'DROP INDEX ' + SYS.INDEXES.NAME + ' ON ' + SYSOBJECTS.NAME AS DROP_INDEX_SCRIPT
                           FROM   SYSOBJECTS,
                                  SYS.INDEXES
                           WHERE  SYSOBJECTS.ID     = SYS.INDEXES.OBJECT_ID
                           AND    SYSOBJECTS.XTYPE  = 'U'
                           ...
                           ORDER BY SYSOBJECTS.NAME,
                                  SYS.INDEXES.NAME";
                reader = this.J_ExecSqlReturnReader(strSQL);
                if (reader == null) return false;

                intCounter = 0;
                while (reader.Read())
                {
                    strArray[intCounter] = reader["DROP_INDEX_SCRIPT"].ToString();
                    intCounter++;
                }
                reader.Close();
                reader.Dispose();
                ...
                for (intCounter = 0; intCounter <= strArray.GetUpperBound(0); intCounter++)
                    if (this.J_ExecSql(this.commonservice.J_ReplaceQuote(strArray[intCounter]), SQLType) == false) return false;
            }
            else if (IndexDropType == J_IndexDropType.Individual)
            {
                ...
                while (reader.Read())
                {
                    strArray[intCounter] = reader["NAME"].ToString();
                    intCounter++;
                }
                reader.Close();
                reader.Dispose();
                ...
                for (intCounter = 0; intCounter <= strArray.GetUpperBound(0); intCounter++)
                {
                    strSQL = "DROP INDEX " + this.commonservice.J_ReplaceQuote(strArray[intCounter]) + " ON " + this.commonservice.J_ReplaceQuote(TableName) + "";
                    if (this.J_ExecSql(strSQL, SQLType) == false) return false;
                }
            }
            return true;
        }
        ...
        public DataSet J_ShowDataInGrid(IDbCommand command, ref DGVControl.DGVControl dgvControl, string SqlText, string[,] arrColumns)
        {
            try
            {
                ...
                for (int intCounter = 0; intCounter <= arrColumns.GetUpperBound(0); intCounter++)
                {
                    ...
                    DataGridViewColumn column = dgvControl.Columns[intColumnIndex];
                    column.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
                    int width = int.Parse(
                        arrColumns[intCounter, (int)J_GridColumnSetting.Width]);
                    ...
                    //-- 2019/04/03
                    else if (arrColumns[intCounter, (int)J_GridColumnSetting.Alignment].Trim() == "C" || arrColumns[intCounter, (int)J_GridColumnSetting.Alignment].Trim().ToUpper() == "CENTRE")
                    {
                        dgvControl.Columns[intColumnIndex].SortMode = DataGridViewColumnSortMode.NotSortable;
                        dgvControl.Columns[intColumnIndex].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
                        dgvControl.Columns[intColumnIndex].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
                    }
        ...
        #region J_setGridPosition [3]
        public bool J_setGridPosition(ref DGVControl.DGVControl dgvControl, DataSet dataset, long IdValue)
        {
            if (dgvControl.CurrentRow == null)
                return false;
            
            if (commonservice.J_ReturnInt64Value(dgvControl.CurrentRow.Index) < 0) return false;

            foreach (DataGridViewRow row in dgvControl.Rows)
            {
                if (Convert.ToInt64(row.Cells[0].Value) == IdValue)
                {
                    row.Selected = true;
                    dgvControl.CurrentCell = dgvControl.Rows[row.Index].Cells[1];
                    break;
                }
            }

            if (dgvControl.CurrentRow.Index < 0) return false;
        ...
        {
            return this.J_CreateSchemaFile(SchemaFolderPath, TableName, TableColumns, J_TextSeparator.Pipe, J_TextQualifier.None, "MM/dd/yyyy", false, null);
        }
        #endregion
        ...
        {
            return this.J_CreateSchemaFile(SchemaFolderPath, TableName, TableColumns, Delimiter, J_TextQualifier.None, "MM/dd/yyyy", false, null);
        }
        #endregion
        ...
        {
            return this.J_CreateSchemaFile(SchemaFolderPath, TableName, TableColumns, Delimiter, Qualifier, "MM/dd/yyyy", false, null);
        }
        #endregion
        ...
        {
            return this.J_CreateSchemaFile(SchemaFolderPath, TableName, TableColumns, Delimiter, Qualifier, DateTimeFormat, false, null);
        }
        #endregion
        ...
        {
            return this.J_CreateSchemaFile(SchemaFolderPath, TableName, TableColumns, Delimiter, Qualifier, DateTimeFormat, Header, null);
        }
        #endregion

        #region J_CreateSchemaFile [6]
        public bool J_CreateSchemaFile(string SchemaFolderPath, string TableName, string TableColumns, string Delimiter, string Qualifier, string DateTimeFormat, bool Header, string OrderBy)
        {
            try
            {
                ...
                strSQL = "SELECT TOP 1 " + TableColumns + " FROM " + TableName;
                if (OrderBy != null) strSQL = strSQL + " ORDER BY " + OrderBy;

                DataTable datatable = this.J_ExecSqlReturnDataTable(strSQL);
        ...
        #region J_Export [4]
        public bool J_Export(string ExportFolderPath, string SourceTableName, string ExportColumns, string Criteria, string OrderBy)
        {
            int NoOfRows = 0;
            return this.ExportFileEngine(ExportFolderPath, J_ExportFileType.TextFile, SourceTableName, ExportColumns, Criteria, J_TextSeparator.Pipe, J_TextQualifier.None, false, OrderBy, out NoOfRows);
        }
        #endregion
        ...
        #region GENERATE TABLE SCRIPT FILE [ OVERLOADED METHODS ]

        #region J_GenerateTableScriptFile [1]
        public bool J_GenerateTableScriptFile(string FolderPath, string TableName, string TableColumns, string Delimiter, string OrderBy)
        {
            try
            {
                ...
                DataTable datatable = this.J_ExecSqlReturnDataTable(strSQL);
                StreamWriter streamWriter = commonservice.J_ReturnStreamWriter(FolderPath + "\\script.rip");

                commonservice.J_WriteLine(ref streamWriter, TableName);
                ...
                foreach (DataColumn column in datatable.Columns)
                {
                    ...
                    {
                        case J_DataTableDataType.Integer:
                            strDesc = column.ColumnName + "|Integer";
                            break;
                        case J_DataTableDataType.Long:
                            strDesc = column.ColumnName + "|Long";
                            break;
                        case J_DataTableDataType.Decimal:
                            strDesc = column.ColumnName + "|Double";
                            break;
                        case J_DataTableDataType.String:
                            strDesc = column.ColumnName + "|String|1000";
                            break;
                        case J_DataTableDataType.DateTime:
                            strDesc = column.ColumnName + "|DateTime";
                            break;
                        case J_DataTableDataType.Byte:
                            strDesc = column.ColumnName + "|Byte";
                            break;
                        case J_DataTableDataType.Boolean:
                            strDesc = column.ColumnName + "|Bit";
                            break;
                        case J_DataTableDataType.Currency:
                            strDesc = column.ColumnName + "|Currency";
                            break;
                        case J_DataTableDataType.Binary:
                            strDesc = column.ColumnName + "|OLE";
                            break;
                    }
                    commonservice.J_WriteLine(ref streamWriter, strDesc);
                }
                
                commonservice.J_WriteLine(ref streamWriter, "");
                streamWriter.Close();
                return true;
            }
            catch
        ...
        #region J_GenerateTableScriptFile [2]
        public bool J_GenerateTableScriptFile(string FolderPath, string TableName, string TableColumns, ref Hashtable hTableMsAccess, ref Hashtable hTableSqlServer)
        {
            try
            {
                ...
                string strScript_MsAccess  = "CREATE TABLE " + TableName + "(";
                string strScript_SqlServer = "CREATE TABLE " + TableName + "(";
                ...
                foreach (DataColumn column in datatable.Columns)
                {
                    ...
                    {
                        case J_DataTableDataType.Integer:
                            strScript_MsAccess  += commonservice.J_GetDataType(column.ColumnName, J_ColumnType.Integer, J_DatabaseType.MsAccess) + ", ";
                            strScript_SqlServer += commonservice.J_GetDataType(column.ColumnName, J_ColumnType.Integer, J_DatabaseType.SqlServer) + ", ";
                            break;
                        case J_DataTableDataType.Long:
                            strScript_MsAccess += commonservice.J_GetDataType(column.ColumnName, J_ColumnType.Long, J_DatabaseType.MsAccess) + ", ";
                            strScript_SqlServer += commonservice.J_GetDataType(column.ColumnName, J_ColumnType.Long, J_DatabaseType.SqlServer) + ", ";
                            break;
                        case J_DataTableDataType.Decimal:
                            strScript_MsAccess += commonservice.J_GetDataType(column.ColumnName, J_ColumnType.Double, J_DatabaseType.MsAccess) + ", ";
                            strScript_SqlServer += commonservice.J_GetDataType(column.ColumnName, J_ColumnType.Double, J_DatabaseType.SqlServer) + ", ";
                            break;
                        case J_DataTableDataType.String:
                            strScript_MsAccess += commonservice.J_GetDataType(column.ColumnName, J_ColumnType.String, 250, J_DatabaseType.MsAccess) + ", ";
                            strScript_SqlServer += commonservice.J_GetDataType(column.ColumnName, J_ColumnType.String, 250, J_DatabaseType.SqlServer) + ", ";
                            break;
                        case J_DataTableDataType.DateTime:
                            strScript_MsAccess += commonservice.J_GetDataType(column.ColumnName, J_ColumnType.DateTime, J_DatabaseType.MsAccess) + ", ";
                            strScript_SqlServer += commonservice.J_GetDataType(column.ColumnName, J_ColumnType.DateTime, J_DatabaseType.SqlServer) + ", ";
                            break;
                        case J_DataTableDataType.Byte:
                            strScript_MsAccess += commonservice.J_GetDataType(column.ColumnName, J_ColumnType.String, 250, J_DatabaseType.MsAccess) + ", ";
                            strScript_SqlServer += commonservice.J_GetDataType(column.ColumnName, J_ColumnType.String, 250, J_DatabaseType.SqlServer) + ", ";
                ...
                strScript_MsAccess = commonservice.J_Left(strScript_MsAccess, strScript_MsAccess.Length - 2) + ")";
                strScript_SqlServer = commonservice.J_Left(strScript_SqlServer, strScript_SqlServer.Length - 2) + ")";

                // script is added to hash table
                hTableMsAccess.Add(TableName, strScript_MsAccess);
                hTableSqlServer.Add(TableName, strScript_SqlServer);
        ...
        #region DATE DIFFERENT [ OVERLOADED METHOD ]

        #region J_DateDiff [1]
        public int J_DateDiff(MaskedTextBox DateMaskedTextBox1, MaskedTextBox DateMaskedTextBox2, J_DateTimeType DateTimeType)
        {
            return this.J_DateDiff(DateMaskedTextBox1.Text, DateMaskedTextBox2.Text, DateTimeType);
        }
        #endregion

        #region J_DateDiff [2]
        public int J_DateDiff(string date1, string date2, J_DateTimeType DateTimeType)
        {
            if (this.J_pDatabaseType == J_DatabaseType.SqlServer)
            {
                if (DateTimeType == J_DateTimeType.DAY)
                    strSQL = "SELECT DATEDIFF(DAY, " + commonservice.J_DateOperator() + dtservice.J_ConvertMMddyyyy(date1) + commonservice.J_DateOperator() + ", " + commonservice.J_DateOperator() + dtservice.J_ConvertMMddyyyy(date2) + commonservice.J_DateOperator() + ") AS DIFFDATE";
                else if (DateTimeType == J_DateTimeType.MONTH)
                    strSQL = "SELECT DATEDIFF(MONTH, " + commonservice.J_DateOperator() + dtservice.J_ConvertMMddyyyy(date1) + commonservice.J_DateOperator() + ", " + commonservice.J_DateOperator() + dtservice.J_ConvertMMddyyyy(date2) + commonservice.J_DateOperator() + ") AS DIFFDATE";
                else if (DateTimeType == J_DateTimeType.YEAR)
                    strSQL = "SELECT DATEDIFF(YEAR, " + commonservice.J_DateOperator() + dtservice.J_ConvertMMddyyyy(date1) + commonservice.J_DateOperator() + ", " + commonservice.J_DateOperator() + dtservice.J_ConvertMMddyyyy(date2) + commonservice.J_DateOperator() + ") AS DIFFDATE";
            }
            else if (this.J_pDatabaseType == J_DatabaseType.MsAccess)
            {
                if (DateTimeType == J_DateTimeType.DAY)
                    strSQL = "SELECT DATEDIFF('D', " + commonservice.J_DateOperator() + dtservice.J_ConvertMMddyyyy(date1) + commonservice.J_DateOperator() + ", " + commonservice.J_DateOperator() + dtservice.J_ConvertMMddyyyy(date2) + commonservice.J_DateOperator() + ") AS DIFFDATE";
                else if (DateTimeType == J_DateTimeType.MONTH)
                    strSQL = "SELECT DATEDIFF('M', " + commonservice.J_DateOperator() + dtservice.J_ConvertMMddyyyy(date1) + commonservice.J_DateOperator() + ", " + commonservice.J_DateOperator() + dtservice.J_ConvertMMddyyyy(date2) + commonservice.J_DateOperator() + ") AS DIFFDATE";
                else if (DateTimeType == J_DateTimeType.YEAR)
                    strSQL = "SELECT DATEDIFF('Y', " + commonservice.J_DateOperator() + dtservice.J_ConvertMMddyyyy(date1) + commonservice.J_DateOperator() + ", " + commonservice.J_DateOperator() + dtservice.J_ConvertMMddyyyy(date2) + commonservice.J_DateOperator() + ") AS DIFFDATE";
            }
            return Convert.ToInt32(this.J_ExecSqlReturnScalar(strSQL));
        }
        #endregion

        #endregion

        #region ReturnUpdateJoinSyntaxSequelServer
        private string ReturnUpdateJoinSyntaxSequelServer(string Query)
        {
            int PosWhere = 0; int PosSet = 0; int PosUpdate = 0; int PosFrom = 0;
            string strWhere = ""; string strUpdate = ""; string strSet = ""; string strFrom = "";
            //--
            try
            {
                ...
                {
                    if (Query.Contains("UPDATE") == false)
                    {
                        return Query;
                    }
                    else
                    {
                        if (Query.Contains("JOIN") == false)
                        {
                            return Query;
                        }
                    }
                }
                //                Query = @"UPDATE ((cor_hdr_deductee_details 
                //         INNER JOIN cor_hdr_challan 
                //                 ON cor_hdr_deductee_details.hdr_challan_id = 
                //                    cor_hdr_challan.hdr_challan_id) 
                //        INNER JOIN cor_hdr_batch 
                //                ON cor_hdr_deductee_details.batch_header_id = 
                //                   cor_hdr_batch.batch_header_id) 
                //SET    cor_hdr_deductee_details.section_id = cor_hdr_challan.section_id 
                //WHERE  cor_hdr_batch.asst_id <= 8 
                //       AND cor_hdr_deductee_details.batch_header_id = 0 ";
                //#################
                Query = Query.ToUpper();
                PosWhere = Query.IndexOf("WHERE", 0);
                //strWhere = SqlText.Substring(PosWhere, SqlText.Length - PosWhere);
                if (PosWhere > 0)
                    strWhere = Query.Substring(PosWhere);
                //
                PosSet = Query.IndexOf("SET", 0);
                if (PosWhere <= 0)
                    strSet = Query.Substring(PosSet, Query.Length - PosSet);
                else
                    strSet = Query.Substring(PosSet, PosWhere - PosSet);
                //
                PosFrom = Query.IndexOf(" ", 0);
                strFrom = Query.Substring(PosFrom, PosSet - PosFrom);
                //
                PosUpdate = strFrom.Trim().IndexOf(" ", 0);
                strUpdate = "UPDATE " + strFrom.Trim().Substring(0, PosUpdate).Trim().Replace("(", "") + " " + strSet + " FROM " + strFrom + " " + strWhere;
                //#################
                return strUpdate;
            }
            catch (Exception ERR)
        ...
        #region ReturnALTERSyntaxSequelServer
        public string ReturnALTERSyntaxSequelServer(string TargetTable,
                                                     string TargetColumn,
                                                     string TargetColumnDataType,
                                                     string TargetColumnDataTypeSize,
                                                     string TargetColumnDataTypeNotNULL,
                                                     string TargetColumnDefaultValue)
        {
            string strAlterSyntax = "";
            //
            //ALTER TABLE MST_SETUP ADD COLUMN ENABLE_LOCK_RETURN NUMBER NOT NULL DEFAULT 0 //-- MS ACCESS
            //ALTER TABLE MST_SETUP ADD ENABLE_LOCK_RETURN1 int NOT NULL DEFAULT 0          //-- SQL SERVER

            //ALTER TABLE MST_SETUP ADD COLUMN SUPER_ANN_YN TEXT(1) NOT NULL DEFAULT \"\"   //-- MS ACCESS
            //ALTER TABLE MST_SETUP ADD SUPER_ANN_YN VARCHAR(1) NOT NULL DEFAULT ''         //-- SQL SERVER 

            //ALTER TABLE MST_SETUP ADD COLUMN SUPER_ANN_FROM_DATE DATE                     //-- MS ACCESS
            //ALTER TABLE MST_SETUP ADD SUPER_ANN_FROM_DATE DATE                            //-- SQL SERVER
            try
            {
                //--
                if (TargetColumnDataTypeSize != "")
                    TargetColumnDataTypeSize = "(" + TargetColumnDataTypeSize + ")";
                else
                    TargetColumnDataTypeSize = "";
                //--
                if (J_Var.J_pDatabaseType == J_DatabaseType.SqlServer)
                {
                    if (TargetColumnDataType == "NUMBER")
                        TargetColumnDataType = "INT";
                    else if (TargetColumnDataType == "TEXT")
                        TargetColumnDataType = "VARCHAR";
                    else if (TargetColumnDataType == "MEMO")
                        TargetColumnDataType = "TEXT";
                    else if (TargetColumnDataType == "MONEY")
                        TargetColumnDataType = "MONEY";
                    //--
                    if (TargetColumnDefaultValue == "\"\"")
                        TargetColumnDefaultValue = " DEFAULT " + "''";
                    else if (TargetColumnDefaultValue == "0")
                        TargetColumnDefaultValue = " DEFAULT 0 ";
                    else
                        TargetColumnDefaultValue = "";
                    //--
                    strAlterSyntax = "ALTER TABLE " + TargetTable + " ADD " + TargetColumn + " " + TargetColumnDataType + " " + TargetColumnDataTypeSize + " " + TargetColumnDataTypeNotNULL + TargetColumnDefaultValue;
                    //--
                }
                else
                {
                    strAlterSyntax = "ALTER TABLE " + TargetTable + " ADD COLUMN " + TargetColumn + " " + TargetColumnDataType + " " + TargetColumnDataTypeSize + " " + TargetColumnDataTypeNotNULL + " DEFAULT " + TargetColumnDefaultValue;
                }
                return strAlterSyntax;
            }
            catch (Exception ERR)
            {
                if (File.Exists(Path.Combine(Application.StartupPath, strErrFile)) == true)
