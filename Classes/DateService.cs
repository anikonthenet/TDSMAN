...
namespace TDSMAN.Classes
{
    public class DateService
    {
        ...
        private const int locaadasd= 0x1F;
        ...
        {
            if (this.J_GetSystemShortDateFormat() != SystemDateFormat)
            {
                if (commonService.J_UserMessage("Current Date Format : " + this.J_GetSystemShortDateFormat() +
        ...
        //Added By Dhrub on 02/12/2013 for Date Format Checking other than "dd-MM-yyyy" and "dd/MM/yyyy"
        #region J_SystemDateFormatCheck_dd_MM_yyyy [4]
        public bool J_SystemDateFormatCheck_dd_MM_yyyy(string SystemDateFormat, string DateFormat1, string DateFormat2)
        {
            return this.J_SystemDateFormatCheck_dd_MM_yyyy(J_Var.J_pProjectName, SystemDateFormat, DateFormat1, DateFormat2);
        }
        #endregion

        //Added By Dhrub on 02/12/2013 for Date Format Checking other than "dd-MM-yyyy" and "dd/MM/yyyy"
        #region J_SystemDateFormatCheck_dd_MM_yyyy [5]
        public bool J_SystemDateFormatCheck_dd_MM_yyyy(string ProjectName, string SystemDateFormat, string DateFormat1, string DateFormat2)
        {
            if ((SystemDateFormat != DateFormat1) && (SystemDateFormat != DateFormat2))
            {
                if (commonService.J_UserMessage("Current Date Format : " + this.J_GetSystemShortDateFormat() +
                                                "\nDate Format is required : " + DateFormat1 +
                                                "\n\n Proceed.....", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.No)
                {
                    return false;
                }
                ...
                {
                    this.J_SetSystemDateFormat(DateFormat1);
                    return true;
                }
            }
            return true;
        ...
        #region J_ConvertyyyyMMdd [3]
        public string J_ConvertyyyyMMdd(string date, bool ReplaceSlash)
        {
            if (date == "" || date == null) return "";
        ...
        #region CONVERT TO STIRNG AS YYYYMM [ OVERLOADED METHOD ]

        #region J_ConvertYYYYMM [1]
        public string J_ConvertYYYYMM(MaskedTextBox MonthYearMaskedTextBox)
        {
            return this.J_ConvertYYYYMM(MonthYearMaskedTextBox.Text);
        }
        #endregion

        #region J_ConvertYYYYMM [2]
        public string J_ConvertYYYYMM(string MonthYear)
        {
            if (MonthYear == "" || MonthYear == null) return "";
            return MonthYear.Substring(3, 4) + "/" + MonthYear.Substring(0, 2);
        }
        #endregion

        #endregion

        #region CONVERT TO INT AS MM [ OVERLOADED METHOD ]

        #region J_getMM [1]
        public int J_getMM(MaskedTextBox MonthYearMaskedTextBox)
        {
            return this.J_getMM(MonthYearMaskedTextBox.Text);
        }
        #endregion

        #region J_getMM [2]
        public int J_getMM(string MonthYear)
        {
            if (MonthYear == "" || MonthYear == null) return 0;
            return Convert.ToInt32(MonthYear.Substring(0, 2));
        }
        #endregion

        #endregion

        #region CONVERT TO INT AS YYYY [ OVERLOADED METHOD ]

        #region J_getYYYY [1]
        public int J_getYYYY(MaskedTextBox MonthYearMaskedTextBox)
        {
            return this.J_getYYYY(MonthYearMaskedTextBox.Text);
        }
        #endregion

        #region J_getYYYY [2]
        public int J_getYYYY(string MonthYear)
        {
            if (MonthYear == "" || MonthYear == null) return 0;
            return Convert.ToInt32(MonthYear.Substring(3, 4));
        }
        #endregion
        ...
        {
            //Added By dhrub and modify the date separater checking on 30/11/2013 
            CultureInfo cultureInfo = CultureInfo.CurrentCulture;
            string strDateSep = cultureInfo.DateTimeFormat.DateSeparator;

            if (dateMaskedTextBox.Text == "  " + strDateSep + "  " + strDateSep)   // dateMaskedTextBox.Text == "  /  /"
            {
            ...
            else if (dateMaskedTextBox.Text == "  " + strDateSep + "  " + strDateSep + "    ")   //dateMaskedTextBox.Text == "  /  /    "
            {
                if (enmShowMessage == J_ShowMessage.YES)
                {
                    commonService.J_UserMessage(DisplayMessage);
        ...
        {
            //Added By Dhrub and modify the dateSeparater Checking on 30/11/2013

            string strDateSep = J_GetSystemDateSeperator();

            if (date == "  " + strDateSep + "  " + strDateSep)    //date == "  /  /"
            {
                if (enmShowMessage == J_ShowMessage.YES)
                    commonService.J_UserMessage(DisplayMessage);
                return true;
            }
            else if (date == "  " + strDateSep + "  " + strDateSep + "    ")   //date == "  /  /    "
            {
                if (enmShowMessage == J_ShowMessage.YES)
                    commonService.J_UserMessage(DisplayMessage);
                return true;
        ...
        #region J_GetSystemShortDateFormat
        public string J_GetSystemShortDateFormat()
        {
            CultureInfo cultureInfo = CultureInfo.CurrentCulture;
        ...
        #region J_GetSystemLongDateFormat
        public string J_GetSystemLongDateFormat()
        {
            CultureInfo cultureInfo = CultureInfo.CurrentCulture;
        ...
        #region J_GetSystemShortTimeFormat
        public string J_GetSystemShortTimeFormat()
        {
            CultureInfo cultureInfo = CultureInfo.CurrentCulture;
        ...
        #region J_GetSystemLongTimeFormat
        public string J_GetSystemLongTimeFormat()
        {
            CultureInfo cultureInfo = CultureInfo.CurrentCulture;
        ...
        #region J_GetSystemDateSeperator
        public string J_GetSystemDateSeperator()
        {
            //Added By Dhrub and modify the dateSeparater Checking on 04/11/2013
            CultureInfo cultureInfo = CultureInfo.CurrentCulture;
            return cultureInfo.DateTimeFormat.DateSeparator;
        }
        #endregion
        ...
        public void J_SetSystemDateFormat(string ShortDateFormat, string Separator)
        {
            ...
            //-- 2019/07/19
            //SetLocaleInfo(lngLCID,  , ShortDateFormat);
            //SetLocaleInfo(lngLCID, , ShortDateFormat);
            //SetLocaleInfo(lngLCID, , ShortDateFormat);
            //--
